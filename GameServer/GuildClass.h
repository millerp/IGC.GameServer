...
public:
    ...
    _GUILD_INFO_STRUCT *
    AddMember(_GUILD_INFO_STRUCT *pNode, LPSTR player_name, int aIndex, int totalcount, int pServer);

    _GUILD_INFO_STRUCT *
    AddMember(LPSTR guild_name, LPSTR player_name, int aIndex, int totalcount, int iGuildStatus, int pServer);

...
void CRaklionBattleOfSelupan::SetState_PATTERN_1() {
    g_Log.AddC(TColor::Brown, "[ RAKLION ][ BattleOfSelupan ] State(%d) -> PATTERN_1 // Life(%d/4800000)",
...
void CRaklionBattleOfSelupan::SetState_PATTERN_2() {
    g_Log.AddC(TColor::Brown, "[ RAKLION ][ BattleOfSelupan ] State(%d) -> PATTERN_2 // Life(%d/4800000)",
               m_iBattleOfSelupanState, m_RaklionSelupan.GetSelupanHP());
...
void CRaklionBattleOfSelupan::SetState_PATTERN_3() {
    g_Log.AddC(TColor::Brown, "[ RAKLION ][ BattleOfSelupan ] State(%d) -> PATTERN_3 // Life(%d/4800000)",
               m_iBattleOfSelupanState, m_RaklionSelupan.GetSelupanHP());
...
void CRaklionBattleOfSelupan::SetState_PATTERN_4() {
    g_Log.AddC(TColor::Brown, "[ RAKLION ][ BattleOfSelupan ] State(%d) -> PATTERN_4 // Life(%d/4800000)",
               m_iBattleOfSelupanState, m_RaklionSelupan.GetSelupanHP());
...
void CRaklionBattleOfSelupan::SetState_PATTERN_5() {
    g_Log.AddC(TColor::Brown, "[ RAKLION ][ BattleOfSelupan ] State(%d) -> PATTERN_5 // Life(%d/4800000)",
               m_iBattleOfSelupanState, m_RaklionSelupan.GetSelupanHP());
...
void CRaklionBattleOfSelupan::SetState_PATTERN_6() {
    g_Log.AddC(TColor::Brown, "[ RAKLION ][ BattleOfSelupan ] State(%d) -> PATTERN_6 // Life(%d/4800000)",
               m_iBattleOfSelupanState, m_RaklionSelupan.GetSelupanHP());
...
void CRaklionBattleOfSelupan::SetState_PATTERN_7() {
    g_Log.AddC(TColor::Brown, "[ RAKLION ][ BattleOfSelupan ] State(%d) -> PATTERN_7 // Life(%d/4800000)",
               m_iBattleOfSelupanState, m_RaklionSelupan.GetSelupanHP());
...
void CRaklionBattleOfSelupan::SetPatternCondition(int iPatternNum, int iCondition) {
    if (iPatternNum < 0 || iCondition < 0) {
        g_Log.AddC(TColor::Red, "[RAKLION][SetPatternCondition] error : PatternNum(%d), Condition(%d)", iPatternNum,
                   iCondition);
    }
...
void CRaklionBattleOfSelupan::SetBattleOfSelupanStateAuto() {
    ...
    if (iSelupanMAXLife <= 0) {
        g_Log.AddC(TColor::Red, "[RAKLION] SelupanMAXLife error : Index(%d), MaxLife(%d)", lpObj->m_Index,
                   lpObj->MaxLife);
        return;
    }
    ...
    if (iSelupanLifePercent < 0) {
        g_Log.AddC(TColor::Red, "[RAKLION] SelupanLifePercent error : Index(%d), MaxLife(%d)", lpObj->m_Index,
                   iSelupanLifePercent);
        return;
    }

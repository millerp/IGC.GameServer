...
public:
    ...
    static BOOL LuaGCServerCmd(lua_State *Lua) {
        GSProtocol.GCServerCmd(lua_tointeger(Lua, 1), lua_tointeger(Lua, 2), lua_tointeger(Lua, 3),
                               lua_tointeger(Lua, 4));
        return true;
    };
    ...
    static BOOL LuagObjAddBuffEffect(lua_State *Lua) {
        BOOL Result = gObjAddBuffEffect(&gObj[lua_tointeger(Lua, 1)], lua_tointeger(Lua, 2), lua_tointeger(Lua, 3),
                                        lua_tointeger(Lua, 4), lua_tointeger(Lua, 5), lua_tointeger(Lua, 6),
                                        lua_tointeger(Lua, 7));
        lua_pushnumber(Lua, Result);
        return Result;
    };
    ...
    static BOOL LuaGCReFillSend(lua_State *Lua) {
        GSProtocol.GCReFillSend(lua_tointeger(Lua, 1), lua_tointeger(Lua, 2), lua_tointeger(Lua, 3),
                                lua_tointeger(Lua, 4), lua_tointeger(Lua, 5));
        return true;
    };

    static BOOL LuaGCManaSend(lua_State *Lua) {
        GSProtocol.GCManaSend(lua_tointeger(Lua, 1), lua_tointeger(Lua, 2), lua_tointeger(Lua, 3),
                              lua_tointeger(Lua, 4), lua_tointeger(Lua, 5));
        return true;
    };
    ...
    static BOOL LuaAddItemBag(lua_State *Lua) {
        g_BagManager.AddItemBag(lua_tointeger(Lua, 1), lua_tointeger(Lua, 2), lua_tointeger(Lua, 3),
                                lua_tostring(Lua, 4));
        return true;
    }
    ...
    static BOOL LuaAddToMLSValueTable(lua_State *Lua) {
        g_MasterLevelSkillTreeSystem.AddToValueTable(lua_tointeger(Lua, 1), lua_tostring(Lua, 2),
                                                     lua_tointeger(Lua, 3));
        return true;
    }

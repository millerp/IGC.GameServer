...
void CRaklionSelupan::RaklionSelupanAct_Berserk_Cancel() {
    ...
    g_Log.Add("[ RAKLION ][ Berserk Cancel ] MinDamage(%d) Damage(%d~%d)", lpObj->m_AttackDamageMin,
...
void CRaklionSelupan::RaklionSelupanAct_Berserk1() {
    ...
    g_Log.Add("[ RAKLION ][ Berserk1 ] Skill Using : Index(%d) Damage(%d~%d)", iSelupanIndex, lpObj->m_AttackDamageMin,
...
void CRaklionSelupan::RaklionSelupanAct_Berserk2() {
    ...
    g_Log.Add("[ RAKLION ][ Berserk2 ] Skill Using : Index(%d) Damage(%d~%d)", iSelupanIndex, lpObj->m_AttackDamageMin,
              lpObj->m_AttackDamageMax);
}
...
void CRaklionSelupan::RaklionSelupanAct_Berserk3() {
    ...
    g_Log.Add("[ RAKLION ][ Berserk3 ] Skill Using : Index(%d) Damage(%d~%d)", iSelupanIndex, lpObj->m_AttackDamageMin,
              lpObj->m_AttackDamageMax);
}
...
void CRaklionSelupan::RaklionSelupanAct_Berserk4() {
    ...
    g_Log.Add("[ RAKLION ][ Berserk4 ] Skill Using : Index(%d) Damage(%d~%d)", iSelupanIndex, lpObj->m_AttackDamageMin,
              lpObj->m_AttackDamageMax);
}

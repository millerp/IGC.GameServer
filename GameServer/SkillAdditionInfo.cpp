...
BOOL CSkillAdditionInfo::Load() {
    ...
    g_Log.Add(
            "[Skill Addition Info] [Infinity Arrow] Skill Time[%d], UseLevel[%d], Arrow MP Consumption +0[%d] +1[%d] +2[%d] +3[%d]",
    ...
    this->m_iFireScreamMaxAttackCountSameSerial = ReadSkill.ReadInt("SkillInfo", "FireScreamMaxAttackCountSameSerial",
                                                                    3);
    ...
    g_Log.Add(
            "[Skill Addition Info] [Fire Scream] Use(%d) : Explosion Distance(%d) - Rate(%d), MaxAttack_SameSerial(%d), SerialInitCount(%d), Check Serial(%d)",
    ...
    wsprintf(szTempLog, "[Skill Addition Info] [SoulBarrier Strengrhen] BaseSkill (Level0):%d",
             this->m_nSoulBarrierManaRate_Level[0]);

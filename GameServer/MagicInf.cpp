    ...
    if (g_MasterLevelSkillTreeSystem.CheckMasterLevelSkill(aSkill) == true) {
        if (MagicDamageC.GetSkillUseType(aSkill) == 4) {
            ...
            if (nBrandOfSkill <= 0 || nBrandOfSkill == aSkill) {
                float fValue = g_MasterLevelSkillTreeSystem.GetMasterSkillValue(MagicDamageC.SkillGet(this->m_Skill),
                                                                                this->m_Level);
                ...
                float fValue = g_MasterLevelSkillTreeSystem.GetMasterSkillValue(MagicDamageC.SkillGet(nBrandOfSkill),
                                                                                10);

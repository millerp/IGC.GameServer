...
bool CLuaBag::MakeItemFromBag(int aIndex, BAG_ITEM *m_Item, CItem &Item, time_t &DurationItem) {
    ...
    this->m_Lua.Generic_Call("EventBagMakeItem", ">iiiiiiiiiii",
                             ...
                             &Item.m_NewOption, &Item.m_SetOption, &Item.m_BonusSocketOption, &SocketCount,
                             &MuunEvolutionItemID, &Duration);
...
bool CLuaBag::MakeItemFromBagForGremoryCase(int aIndex, BAG_ITEM *m_Item, _stGremoryCaseItem &Item) {
    ...
    this->m_Lua.Generic_Call("EventBagMakeItem", ">iiiiiiiii",
                             ...
                             &Item.btItemExcOption, &Item.btItemSetOption, &Item.btItemMainAttribute,
                             &Item.btItemSocketCount, &MuunEvolutionItemID, &Duration);

    Item.wItemID = ITEMGET(m_Item->btItemType, m_Item->wItemIndex);

    if (Durability == 0) {
        Item.btItemDurability = ItemGetDurability(Item.wItemID, Item.btItemLevel, Item.btItemExcOption,
                                                  Item.btItemSetOption);
    } else {

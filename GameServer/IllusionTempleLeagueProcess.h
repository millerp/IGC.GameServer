...
public:
    ...
    void GDSaveITLUserPoint(int index, char *UserName, char *GuildName, int nOccupiedCount, int KillPoint,
                            int nInvalidationCount, int nType, int nEnterCount, int nWin);
    ...
    int ReEnterUserIllusionTempleLeague(int aIndex, BYTE btTempleIndex, int nGuildIdx, int nPartyIdx, int nUserArrayNo,
                                        BYTE TeamIdx);

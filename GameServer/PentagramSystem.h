...
public:
    ...
    bool MakePentagramSocketSlot(CItem *lpItemData, BYTE btSocketSlot1, BYTE btSocketSlot2, BYTE btSocketSlot3,
    ...
    bool SetPentagramSocketSlot(CItem *lpTargetItem, BYTE bt1RankOptionNum, BYTE bt1RankLevel, BYTE bt2RankOptionNum,
                                BYTE bt2RankLevel, BYTE bt3RankOptionNum, BYTE bt3RankLevel, BYTE bt4RankOptionNum,
                                BYTE bt4RankLevel, BYTE bt5RankOptionNum, BYTE bt5RankLevel, BYTE curRank);

    bool SwitchPentagramJewel(int aIndex, CItem *lpSourceItem, int iSwitchType);

    bool
    AddPentagramJewelInfo(int aIndex, int iJewelPos, int iJewelIndex, int iItemType, int iItemIndex, int iMainAttribute,
                          int iJewelLevel, BYTE btRank1OptionNum, BYTE btRank1Level, BYTE btRank2OptionNum,
                          BYTE btRank2Level, BYTE btRank3OptionNum, BYTE btRank3Level, BYTE btRank4OptionNum,
    ...
    void DBREQ_InsertPentagramJewel(int aIndex, int iJewelPos, int iJewelIndex, int iItemType, int iItemIndex,
                                    int iMainAttribute, int iJewelLevel, BYTE btRank1, BYTE btRank1Level, BYTE btRank2,
                                    BYTE btRank2Level, BYTE btRank3, BYTE btRank3Level, BYTE btRank4, BYTE btRank4Level,
                                    BYTE btRank5, BYTE btRank5Level);

    int PentagramJewel_IN(int aIndex, int iPentagramItemPos, int iJewelItemPos);

    int
    PentagramJewel_OUT(int aIndex, int iPentagramItemPos, BYTE btSocketIndex, BYTE *btJewelPos, BYTE *btJewelDBIndex);

...
public:
    ...
    void RequestDBToModifyUPTUserInfo(int aIndex, char *szCharName, WORD wTwinkleType, int iCurrentStage,
                                      BYTE byRequestType);
    ...
    BOOL CheckValidationMineState(int aIndex, WORD wTwinkleIndex, WORD wTwinkleType, BYTE byMapNumber, WORD wUserIndex,
                                  int *iResult, bool bRewardCheck);

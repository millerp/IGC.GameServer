...
public:
    ...
    void GCMagicListOneSend(int aIndex, char Pos, unsigned short type, unsigned char level, unsigned short skill,
                            BYTE btListType);

    void
    GCMagicListOneDelSend(int aIndex, char Pos, unsigned short type, BYTE level, unsigned short skill, BYTE btListType);
    ...
    void GCSkillKeySend(int aIndex, unsigned char *keybuffer, unsigned char GO, unsigned char Qk, unsigned char Wk,
                        unsigned char Ek, /*<regrel ebp+0x20>*/ /*|0x1|*/ unsigned char ChatWnd, unsigned char Rk,
                        int QWER);
    ...
    void GCAnsInJewelPentagramItem(int aIndex, int iResult, BYTE btJewelPos, BYTE btJewelIndex, BYTE btItemType,
                                   WORD wItemIndex, BYTE btMainAttribute, BYTE btLevel, BYTE btRank1OptionNum,
                                   BYTE btRank1Level, BYTE btRank2OptionNum, BYTE btRank2Level, BYTE btRank3OptionNum,
                                   BYTE btRank3Level, BYTE btRank4OptionNum, BYTE btRank4Level, BYTE btRank5OptionNum,
                                   BYTE btRank5Level);

...
BOOL CKanturuMonsterMng::LoadData(LPSTR lpszFileName) {
    ...
    try {
        ...
        for (pugi::xml_node monster = main.child("Monster"); monster; monster = monster.next_sibling()) {
            ...
            this->SetMonsterSetBaseInfo(this->m_iMaxMonsterCount, btGroup, wType, btMapNumber, btDistance, btX, btY,
                                        btDir);
...
void CKanturuMonsterMng::SetMonsterSetBaseInfo(int iIndex, BYTE btGroup, WORD wType, BYTE btMapNumber, BYTE btDistance,
                                               BYTE btX, BYTE btY, BYTE btDir) {

...
#define MAX_PLAYER_EQUIPMENT 12    // need to redo agin a�� with this macro
...
public:
    ...
    void SetCharacter(int Class, int Str, int Dex, int Vit, int Energy, float Life, float Mana, float LevelLife,

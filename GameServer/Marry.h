...
inline bool isFemale(int aIndex) {
    return (gObj[aIndex].Class == CLASS_ELF || gObj[aIndex].Class == CLASS_SUMMONER ||
            gObj[aIndex].Class == CLASS_GROWLANCER) ? true : false;
}

inline bool isMale(int aIndex) {
    return (gObj[aIndex].Class == CLASS_WIZARD || gObj[aIndex].Class == CLASS_KNIGHT ||

...
BOOL CSetItemOption::LoadOptionInfo(LPSTR filename) {
    ...
    for (int i = 0; i < MAX_SETITEM_OPTION; i++) {
        memset(&this->m_SetItemOptionInfo[i].SetOptionTable[0], -1,
               sizeof(this->m_SetItemOptionInfo[0].SetOptionTable));
        memset(&this->m_SetItemOptionInfo[i].SetExPOptionTable, -1,
               sizeof(this->m_SetItemOptionInfo[0].SetExPOptionTable));
        memset(&this->m_SetItemOptionInfo[i].SetFullOtionTable[0], -1,
               sizeof(this->m_SetItemOptionInfo[0].SetFullOtionTable));
    }
...
int CSetItemOption::GenRandomItemNum() {
    ...
    do {
        int maxindex = (g_MaxItemIndexOfEachItemType[iSectionIdx] <= 0) ? MAX_SUBTYPE_ITEMS
                                                                        : g_MaxItemIndexOfEachItemType[iSectionIdx];
...
int CSetItemOption::GenRandomItemNumByCat(int iCat) {
    ...
    do {
        int maxindex = (g_MaxItemIndexOfEachItemType[iCat] <= 0) ? MAX_SUBTYPE_ITEMS
                                                                 : g_MaxItemIndexOfEachItemType[iCat];
        int index = rand() % maxindex;

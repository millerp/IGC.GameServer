...
void
CSeedItem::SetOption(BYTE SeedIndex, BYTE SeedType, BYTE ItemLevel, BYTE SeedOptionValueType, WORD *SeedOptionValue,
                     int ExtractRate) {
    ...
    switch (SeedType) {
        case SEED_TYPE_FIRE:
            m_ItemCode = ITEMGET(12, 60);
            break;
        case SEED_TYPE_WATER:
            m_ItemCode = ITEMGET(12, 61);
            break;
        case SEED_TYPE_ICE:
            m_ItemCode = ITEMGET(12, 62);
            break;
        case SEED_TYPE_WIND:
            m_ItemCode = ITEMGET(12, 63);
            break;
        case SEED_TYPE_LIGHTNING:
            m_ItemCode = ITEMGET(12, 64);
            break;
        case SEED_TYPE_EARTH:
            m_ItemCode = ITEMGET(12, 65);
            break;
        case SEED_TYPE_UNIQUE:
            m_ItemCode = ITEMGET(12, 66);
            break;
    }
}
...
void CSphereItem::SetOption(BYTE SphereLevel, int ValueIncreaseRate) {
    ...
    switch (SphereLevel) {
        case 1:
            m_ItemCode = ITEMGET(12, 70);
            break;
        case 2:
            m_ItemCode = ITEMGET(12, 71);
            break;
        case 3:
            m_ItemCode = ITEMGET(12, 72);
            break;
        case 4:
            m_ItemCode = ITEMGET(12, 73);
            break;
        case 5:
            m_ItemCode = ITEMGET(12, 74);
            break;
    }
}

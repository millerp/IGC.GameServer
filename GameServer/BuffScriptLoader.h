...
public:
    ...
    bool AddBuffEffectData(BYTE btBuffIndex, BYTE btBuffEffectType, BYTE btItemType, WORD wItemIndex, char *pchName,
                           BYTE btBuffType, BYTE btNoticeType, BYTE btClearType, char *pchDescript);

    void AddPeriodBuffEffectInfo(WORD wBuffIndex, BYTE btEffectType1, WORD wEffectValue1, BYTE btEffectType2,

...
bool CBuffScriptLoader::Load(char *pchFileName) {
    ...
    for (pugi::xml_node buff = general.child("Buff"); buff; buff = buff.next_sibling()) {
        ...
        AddBuffEffectData(btBuffIndex, btBuffEffectType, ItemType, ItemIndex, chBuffName, btBuffType, btNoticeType,
                          btClearType, chBuffDescript);
    }
...
bool CBuffScriptLoader::AddBuffEffectData(BYTE btBuffIndex, BYTE btBuffEffectType, BYTE btItemType, WORD wItemIndex,
                                          char *pchName, BYTE btBuffType, BYTE btNoticeType, BYTE btClearType,
                                          char *pchDescript) {
...
void
CBuffScriptLoader::AddPeriodBuffEffectInfo(WORD wBuffIndex, BYTE btEffectType1, WORD wEffectValue1, BYTE btEffectType2,
                                           WORD wEffectValue2, DWORD dwDuration) {

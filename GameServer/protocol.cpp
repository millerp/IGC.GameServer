...
if ( nRet != ENEWPVP::E_NO_ERROR )
{
PMSG_ANS_DUEL_LEAVECNANNEL res = {
0
};
res.h.c = 0xC1;
...
PMSG_RELATIONSHIP_JOIN_BREAKOFF_ANS ErrMsg={
0
};
...
char szCastleOwnerGuildName[MAX_GUILD_LEN+1]={
0
};
...
char szUnionMemberGuildName[MAX_GUILD_LEN+1] = {
0
};
...
if ( lpGuild != NULL )
{
PMSG_ANS_GUILDMARK_OF_CASTLEOWNER pMsg = {
0
};
...
char szDuelName[MAX_ACCOUNT_LEN+1] = {
0
};

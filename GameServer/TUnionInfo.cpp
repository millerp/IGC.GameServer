...
BOOL TUnionInfo::IsUnionMember(int iGuildNumber) {
    this->m_Sync.Lock();
    std::vector<int>::iterator _Itor = std::find(this->m_vtUnionMember.begin(), this->m_vtUnionMember.end(),
                                                 iGuildNumber);
...
BOOL TUnionInfo::IsRivalMember(int iGuildNumber) {
    this->m_Sync.Lock();
    std::vector<int>::iterator _Itor = std::find(this->m_vtRivalMember.begin(), this->m_vtRivalMember.end(),
                                                 iGuildNumber);

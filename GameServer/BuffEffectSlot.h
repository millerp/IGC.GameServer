...
public:
    ...
    int SetEffect(LPOBJECTSTRUCT lpObj, int iBuffIndex, BYTE btEffectType1, BYTE btEffectType2, int iEffectValue1,
                  int iEffectValue2, int iDuration);
...
extern bool
gObjAddBuffEffect(LPOBJECTSTRUCT lpObj, int iBuffIndex, BYTE EffectType1, int EffectValue1, BYTE EffectType2,
...
extern void
GCUseBuffEffect(LPOBJECTSTRUCT lpObj, BYTE BuffEffectIndex, BYTE EffectUseOption, WORD OptionType, WORD EffectType,
                int LeftTime, DWORD EffectValue);

extern void gObjSendBuffList(LPOBJECTSTRUCT lpObj);

extern BOOL gObjAddBuffEffectWideArea(LPOBJECTSTRUCT lpTargetObj, int nDistance, int &nAffectedCount, int iBuffIndex,
                                      BYTE EffectType1, int EffectValue1, BYTE EffectType2, int EffectValue2,
                                      int Duration);

extern void CheckItemOptForGetExpExRenewal(LPOBJECTSTRUCT lpObj, LPOBJ lpTargetObj, UINT64 &iExp, UINT64 iDefaultExp,
                                           BOOL bRewardExp);

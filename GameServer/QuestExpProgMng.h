...
public:
    ...
    bool GetSendQuestInfo(QuestExpInfo *pQuestExpInfo, DWORD dwQuestInfoIndexID, int iObjIndex,
    ...
    void
    ChkUserQuestTypeSkillLearn(QuestSkillLearn *pQuestSkillLearn, UserQuestAskInfo *pUserQuestAskInfo, int iObjIndex);
    ...
    void ChkMonsterKillPartyPlay(DWORD dwQuestInfoIndexID, int iAskIndex, QuestMonsterKill *pQuestMonsterKill,

...
void SERVER_CONFIG::ReadServerInfo(bool bObjInit) {
    ...
    strncpy(this->szServerName, ReadServerInfo.ReadString("GameServerInfo", "ServerName", "").c_str(),
            sizeof(this->szServerName));
    ...
    strncpy(this->szJoinServerIP, ReadServerInfo.ReadString("GameServerInfo", "JoinServerIP", "127.0.0.1").c_str(),
            sizeof(this->szJoinServerIP));
    strncpy(this->szDataServerIP, ReadServerInfo.ReadString("GameServerInfo", "DataServerIP", "127.0.0.1").c_str(),
            sizeof(this->szDataServerIP));
    strncpy(this->szExDBIP, ReadServerInfo.ReadString("GameServerInfo", "ExDBIP", "127.0.0.1").c_str(),
            sizeof(this->szExDBIP));
    strncpy(this->szConnectServerIP, ReadServerInfo.ReadString("GameServerInfo", "ConnectServerIP", "").c_str(),
            sizeof(this->szConnectServerIP));
    ...
    strncpy(this->szCashShopLogPath,
            ReadServerInfo.ReadString("GameServerInfo", "ItemShopLogPath", ".\\ITEM_SHOP_LOG").c_str(),
            sizeof(this->szCashShopLogPath));
    strncpy(this->szUserSaveLogPath,
            ReadServerInfo.ReadString("GameServerInfo", "CharSaveLogPath", ".\\CHAR_SAVE_LOG").c_str(),
            sizeof(this->szUserSaveLogPath));
    strncpy(this->szCommandLogPath,
            ReadServerInfo.ReadString("GameServerInfo", "CommandLogPath", ".\\COMMANDS_SAVE_LOG").c_str(),
            sizeof(this->szCommandLogPath));
    strncpy(this->szServerLogPath,
            ReadServerInfo.ReadString("GameServerInfo", "ServerStateLogPath", ".\\SERVER_CONN_STATE_LOG").c_str(),
            sizeof(this->szServerLogPath));
    strncpy(this->szMsgLogPath, ReadServerInfo.ReadString("GameServerInfo", "MessageLogPath", ".\\MESSAGE_LOG").c_str(),
            sizeof(this->szMsgLogPath));
    strncpy(this->szTradeLogPath, ReadServerInfo.ReadString("GameServerInfo", "TradeLogPath", ".\\TRADE_LOG").c_str(),
            sizeof(this->szTradeLogPath));
    strncpy(this->szGMLogPath, ReadServerInfo.ReadString("GameServerInfo", "GMLogPath", ".\\GM_LOG").c_str(),
            sizeof(this->szGMLogPath));
    strncpy(this->szAntiHackLogPath,
            ReadServerInfo.ReadString("GameServerInfo", "AntiHackLogPath", ".\\ANTI_HACK").c_str(),
            sizeof(this->szAntiHackLogPath));
    strncpy(this->szBotShopLogPath,
            ReadServerInfo.ReadString("GameServerInfo", "BotShopLog", ".\\BOT_SHOP_LOG").c_str(),
            sizeof(this->szBotShopLogPath));
    strncpy(this->szSerialCheckLogPath,
            ReadServerInfo.ReadString("GameServerInfo", "SerialCheckLogPath", ".\\SERIAL_CHECK_LOG").c_str(),
            sizeof(this->szSerialCheckLogPath));
...
void CConfigread::ReadConfig() {
    ...
    this->data.common.WelcomeMessage = ReadCommon.ReadString("General", "WelcomeMessage",
                                                             "Welcome to our Mu Online server!");
    ...
    this->data.reset.iBlockLevelUpPointAfterResets = ReadCommon.ReadInt("ResetCMD", "BlockLevelUpPointAfterResetCount",
                                                                        0);
    ...
    g_Log.Add("Official MuBot: Enabled: %s, Minimum Level: %d, Auto Disable Time: %d minutes",
              this->data.mubot.enable == true ? "Yes" : "No", this->data.mubot.minlevel,
              this->data.mubot.autodisabletime);
    ...
    this->data.common.SocketExcLimit = ReadCommon.ReadInt("General", "CanUseSocketExcItem",
                                                          1); // 0 - disable, 1 - enabled without drop, 2 - enabled with drop from monsters
    ...
    this->data.common.XMasSantaFirstPrizeMaxCount = ReadCommon.ReadInt("SantaVillage", "SantaClause1stPrizeMaxVisit",
                                                                       1);
    this->data.common.XMasSantaSecondPrizeMaxCount = ReadCommon.ReadInt("SantaVillage", "SantaClause2ndPrizeMaxVisit",
                                                                        3);
    ...
    this->data.common.DisableMSBEffect[MSB_DISABLE_MONSTER] = ReadCommon.ReadInt("joinmu", "DisableMSBEffect_Monster",
                                                                                 0);
    this->data.common.DisableMSBEffect[MSB_DISABLE_CHARACTER] = ReadCommon.ReadInt("joinmu",
                                                                                   "DisableMSBEffect_Character", 0);
    this->data.common.DisableMSBEffect[MSB_DISABLE_CHARACTER_FENRIR] = ReadCommon.ReadInt("joinmu",
                                                                                          "DisableMSBEffect_Character_Fenrir",
                                                                                          0);
    ...
    this->data.common.PetEventBookMoonRabbitSpawnRate = ReadCommon.ReadInt("EggEvent", "MoonRabbitSpawnRateFromBook",
                                                                           3000);
    this->data.common.PetEventBookLuckyBagSpawnRate = ReadCommon.ReadInt("EggEvent", "PouchBlessingSpawnRateFromBook",
                                                                         3000);
    this->data.common.PetEventBookFireFlameSpawnRate = ReadCommon.ReadInt("EggEvent", "FireFlameSpawnRateFromBook",
                                                                          3000);
    this->data.common.PetEventBookGoldGoblinSpawnRate = ReadCommon.ReadInt("EggEvent", "GoldGoblinSpawnRateFromBook",
                                                                           1000);
    ...
    this->data.common.joinmuRemoveItemSellDropRestriction = ReadCommon.ReadInt("joinmu",
                                                                               "RemoveItemSellDropRestriction", 0);
...
void CConfigread::ReadPKSettings() {
    ...
    for (pugi::xml_node pk = exp_dec.child("PK"); pk; pk = pk.next_sibling()) {
        ...
        for (pugi::xml_node level_range = pk.child(
                "LevelRange"); level_range; level_range = level_range.next_sibling()) {

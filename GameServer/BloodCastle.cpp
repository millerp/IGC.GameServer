    ...
    for (pugi::xml_node castle = main.child("Castle"); castle; castle = castle.next_sibling()) {
        ...
        for (pugi::xml_node monster = bosses.child("Monster"); monster; monster = monster.next_sibling()) {
            ...
            if (BC_MAP_RANGE(this->m_BCMP_BossMonster[iBridgeIndex][iCount].m_MapNumber) == FALSE) {
                g_Log.MsgBox("[BloodCastle][LoadMonster] Boss Monster Map Number Invalid (%d)",
                             this->m_BCMP_BossMonster[iBridgeIndex][iCount].m_MapNumber);
                continue;
            }
        ...
        for (pugi::xml_node monster = general.child("Monster"); monster; monster = monster.next_sibling()) {
            ...
            if (BC_MAP_RANGE(this->m_BCMP_General[iBridgeIndex][iCount].m_MapNumber) == FALSE) {
                g_Log.MsgBox("[BloodCastle][LoadMonster] General Monster Map Number Invalid (%d)",
                             this->m_BCMP_General[iBridgeIndex][iCount].m_MapNumber);
                continue;
            }
...
void CBloodCastle::CheckSync(int iBridgeIndex) {
    ...
    g_Log.Add("[Blood Castle] (%d) Sync Open Time. [%I64d] min remain", iBridgeIndex + 1,
              this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC / 60000);
}
...
void CBloodCastle::ClearBridgeData(int iBridgeIndex) {
    ...
    memset(this->m_BridgeData[iBridgeIndex].m_szKill_Door_CharName, 0,
           sizeof(this->m_BridgeData[iBridgeIndex].m_szKill_Door_CharName));
    memset(this->m_BridgeData[iBridgeIndex].m_szKill_Status_CharName, 0,
           sizeof(this->m_BridgeData[iBridgeIndex].m_szKill_Status_CharName));
    memset(this->m_BridgeData[iBridgeIndex].m_szWin_Quest_CharName, 0,
           sizeof(this->m_BridgeData[iBridgeIndex].m_szWin_Quest_CharName));
    memset(this->m_BridgeData[iBridgeIndex].m_szKill_Door_AccountID, 0,
           sizeof(this->m_BridgeData[iBridgeIndex].m_szKill_Door_AccountID));
    memset(this->m_BridgeData[iBridgeIndex].m_szKill_Status_AccountID, 0,
           sizeof(this->m_BridgeData[iBridgeIndex].m_szKill_Status_AccountID));
    memset(this->m_BridgeData[iBridgeIndex].m_szWin_Quest_AccountID, 0,
           sizeof(this->m_BridgeData[iBridgeIndex].m_szWin_Quest_AccountID));
...
void CBloodCastle::ProcState_Closed(int iBridgeIndex) {
    ...
    if (i64TICK_MSEC >= 1000) {
        ...
        if (this->IsEventEnable() != FALSE) {
            ...
            if (this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC <= (this->m_iBC_TIME_MIN_OPEN * 60 * 1000) &&
                this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC > 0 &&
                (this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC / 60000) !=
                this->m_BridgeData[iBridgeIndex].m_iBC_NOTIFY_COUNT) {
                this->m_BridgeData[iBridgeIndex].m_iBC_NOTIFY_COUNT =
                        this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC / 60000;
                ...
                if (iBridgeIndex == 0) {
                    ...
                    TNotice::MakeNoticeMsgEx(&pNotice, 0, Lang.GetText(0, 65),
                                             this->m_BridgeData[iBridgeIndex].m_iBC_NOTIFY_COUNT + 1);
                    this->SendAllUserAnyMsg((BYTE * ) & pNotice, pNotice.h.size);
                }
            }

            if (this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC <= 30000 &&
                this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC > 0 &&
                this->m_BridgeData[iBridgeIndex].m_bBC_MSG_BEFORE_ENTER == false) {
                ...
                if (iBridgeIndex == 0) {
                    ...
                    for (int i = g_ConfigRead.server.GetObjectStartUserIndex();
                         i < g_ConfigRead.server.GetObjectMax(); i++) {
...
void CBloodCastle::ProcState_Playing(int iBridgeIndex) {
    ...
    if (i64TICK_MSEC >= 1000) {
            ...
            if (this->m_BridgeData[iBridgeIndex].m_i64_BC_TICK_DOOR_OPEN != -1) {
                if (GetTickCount64() > this->m_BridgeData[iBridgeIndex].m_i64_BC_TICK_DOOR_OPEN) {
                    ...
                    if (this->m_BridgeData[iBridgeIndex].m_iBC_DOOR_MONSTER_INDEX == -1) //season 2.5 add-on
                    {
                        ...
                        g_Log.Add("[Blood Castle] (%d) Door Subsist (%d)(Name: %s)(Dieregen:%d)", iBridgeIndex + 1,
                                  this->m_BridgeData[iBridgeIndex].m_iBC_DOOR_MONSTER_INDEX,
                                  gObj[this->m_BridgeData[iBridgeIndex].m_iBC_DOOR_MONSTER_INDEX].Name,
                                  gObj[this->m_BridgeData[iBridgeIndex].m_iBC_DOOR_MONSTER_INDEX].DieRegen);
                    }
                }
            }
        }
        ...
        // Set Play Quest
        if (this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC <= ((this->m_iBC_TIME_MIN_PLAY * 60 - 60) * 1000) &&
            this->m_BridgeData[iBridgeIndex].m_bBC_PLAY_START == false) {
            PMSG_NOTICE pNotice;
        ...
        if (this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC <= 30000 &&
            this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC > 0 &&
            this->m_BridgeData[iBridgeIndex].m_bBC_MSG_BEFORE_END == false)    // Set counter to kick
        {
        ...
        if (this->CheckEveryUserDie(iBridgeIndex) != false) {
            ...
            if (this->m_BridgeData[iBridgeIndex].m_bBC_PLAY_START != false) {
                if (this->m_BridgeData[iBridgeIndex].m_bBC_DOOR_TERMINATE_COMPLETE == false ||
                    this->m_BridgeData[iBridgeIndex].m_bBC_BOSS_MONSTER_KILL_COMPLETE != false) {
...
void CBloodCastle::SetState_Playing(int iBridgeIndex) {
    ...
    for (int n = g_ConfigRead.server.GetObjectStartUserIndex(); n < g_ConfigRead.server.GetObjectMax(); n++) {
        if (gObj[n].MapNumber == this->GetBridgeMapNumber(iBridgeIndex) &&
            gObj[n].Connected > PLAYER_LOGGED) //season3 changed
        {
            this->SearchUserDeleteQuestItem(n);
        }
    }
...
int CBloodCastle::CheckEnterLevel(int iIndex,
                                  int iLevel)    // RET : [2:Error][1:OverLevel][0:InLevel - Success][-1:UnderLevel]
{
    ...
    if (gObj[iIndex].Class == CLASS_DARKLORD || gObj[iIndex].Class == CLASS_MAGUMSA ||
        gObj[iIndex].Class == CLASS_RAGEFIGHTER) {
        ...
        if (gObj[iIndex].Level >= g_sttBLOODCASTLE_LEVEL[iLevel - 1].iLOWER_BOUND_MAGUMSA &&
            gObj[iIndex].Level <= g_sttBLOODCASTLE_LEVEL[iLevel - 1].iUPPER_BOUND_MAGUMSA) {
            return 0;
        }
        ...
        if (gObj[iIndex].Level >= g_sttBLOODCASTLE_LEVEL[iLevel - 1].iLOWER_BOUND &&
            gObj[iIndex].Level <= g_sttBLOODCASTLE_LEVEL[iLevel - 1].iUPPER_BOUND) {
            return 0;
        }
...
bool CBloodCastle::BloodCastleChaosMix(int iIndex, int iLEVEL) {
    ...
    g_Log.Add("[Blood Castle] BloodCastle Ticket Mix Chaos Mix Start (Account:%s, Name:%s, Level:%d)",
    ...
    if (iMIX_SUCCESS_RATE < 0 || iMIX_SUCCESS_RATE > 100) {
        ...
        g_Log.Add(
                "[Blood Castle] BloodCastle Ticket Mix Chaos Mix Failed - MixRate Out of Bound (Account:%s, Name:%s, Level:%d)",
                gObj[iIndex].AccountID, gObj[iIndex].Name, iLEVEL);
        return false;
    }
    ...
    int iChaosTaxMoney = (int) ((__int64)(iMIX_NEED_MONEY) * (__int64)(g_CastleSiegeSync.GetTaxRateChaos(iIndex)) /
                                (__int64) 100);
    ...
    if (iMIX_NEED_MONEY < 0) {
        IOCP.DataSend(iIndex, (LPBYTE) & pMsg, pMsg.h.size);
        g_Log.Add(
                "[Blood Castle] BloodCastle Ticket Mix Chaos Mix Failed - MixMoney < 0 (Account:%s, Name:%s, Level:%d)",
                gObj[iIndex].AccountID, gObj[iIndex].Name, iLEVEL);
        return false;
    }
    ...
    if ((gObj[iIndex].m_PlayerData->Money - iMIX_NEED_MONEY) < 0) {
        ...
        IOCP.DataSend(iIndex, (LPBYTE) & pMsg, pMsg.h.size);
        g_Log.Add(
                "[Blood Castle] BloodCastle Ticket Mix Chaos Mix Failed - Not Enough Money (Account:%s, Name:%s, Level:%d)",
                gObj[iIndex].AccountID, gObj[iIndex].Name, iLEVEL);
        return false;
    }
    ...
    if ((rand() % 100) < iMIX_SUCCESS_RATE) {
        ...
        g_Log.Add("[BloodCastle Ticket Mix] [%s][%s] CBMix Success %d Money : %d-%d", gObj[iIndex].AccountID,
                  gObj[iIndex].Name, iMIX_SUCCESS_RATE, gObj[iIndex].m_PlayerData->Money, iMIX_NEED_MONEY);
    } else {
        g_MixSystem.ChaosBoxInit(&gObj[iIndex]);
        GSProtocol.GCUserChaosBoxSend(&gObj[iIndex], 0);
        IOCP.DataSend(iIndex, (LPBYTE) & pMsg, pMsg.h.size);
        g_Log.Add("[BloodCastle Ticket Mix] [%s][%s] CBMix Fail %d Money : %d-%d", gObj[iIndex].AccountID,
                  gObj[iIndex].Name, iMIX_SUCCESS_RATE, gObj[iIndex].m_PlayerData->Money, iMIX_NEED_MONEY);
        return false;
    }
...
int CBloodCastle::GetRemainTime(int iBridgeIndex) {
    ...
    if (this->GetCurrentState(iBridgeIndex) == 1) {
        iREMAIN_MINUTE =
                (int) this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC / 60000 - this->m_iBC_TIME_MIN_OPEN + 1;
    } else {
        ...
        for (it = this->m_listBloodCastleOpenTime.begin();
             it != this->m_listBloodCastleOpenTime.end(); ++it) //for identical
        {
        ...
        for (loc13 = 2; loc13--;) //good ->func identical so far
        {
            ...
            if (iREMAIN_MINUTE <= (this->m_iBC_TIME_MIN_OPEN * 60 *
                                   1000)) //should be if ( iREMAIN_MINUTE <= ( this->m_iBC_TIME_MIN_OPEN * 60 * 1000 ))
            {
                it++;
...
void CBloodCastle::ClearMonster(int iBridgeIndex, bool bClearCastleDoor) {
    ...
    g_Log.Add("[Blood Castle] (%d) Perform to Delete Monsters (ClearDoor:%d)", iBridgeIndex + 1,
              bClearCastleDoor); //season 2.5 add-on
...
void CBloodCastle::SetMonster(int iBridgeIndex) {
    ...
    if (iIndex >= 0) {
        ...
        g_Log.Add("[Blood Castle] (%d) Create Door Successfuly : Index(%d)", btBloodCastleIndex + 1,
                  this->m_BridgeData[btBloodCastleIndex].m_iBC_DOOR_MONSTER_INDEX = iIndex); //season 2.5 add-on
    } else {
    ...
    for (int i = 0; i < this->m_iBC_GENERAL_SCRIPT_CNT[iBridgeIndex]; i++) {
        if (BC_MAP_RANGE(this->m_BCMP_General[iBridgeIndex][i].m_MapNumber) != FALSE) {
            ...
            if (wIndex == 89 || wIndex == 95 || wIndex == 112 || wIndex == 118 || wIndex == 124 || wIndex == 130 ||
                wIndex == 143 || wIndex == 433) //season3 changed
            {
                continue;
            }
            ...
            g_Log.AddC(TColor::Red, "[Blood Castle] (%d) Create Monster Fail - Wrong Map (%d) Pos:%d",
                       btBloodCastleIndex + 1, this->m_BCMP_General[iBridgeIndex][i].m_MapNumber,
                       i); //season 2.5 add-on
        }
    }
}
...
void CBloodCastle::SetBossMonster(int iBridgeIndex) {
    ...
    for (int x = 0; x < this->m_iBC_BOSS_SCRIPT_CNT[iBridgeIndex]; x++) {
        ...
        if (wMonsterType == 89 || wMonsterType == 95 || wMonsterType == 112 || wMonsterType == 118 ||
            wMonsterType == 124 || wMonsterType == 130 || wMonsterType == 143 || wMonsterType == 433) {
            int iIndex = ::gObjAddMonster(btMapNumber);
...
void CBloodCastle::SetSaintStatue(int iBridgeIndex) {
    ...
    if (BC_STATUE_RANGE(wMonsterType - 132) != FALSE) {
        ...
        g_Log.Add("[Blood Castle][Bug Tracer] (%d) It's not Saint Statue( Map:%d, BloodCastleIndex:%d, Type:%d )",
                  iBridgeIndex + 1, btMapNumber, this->GetBridgeIndex(btMapNumber), wMonsterType); //season3 changed
    }
}
...
int CBloodCastle::LevelUp(int iIndex, int iAddExp) {
    ...
    g_Log.Add(
            "[Blood Castle] Experience : [%s][%s](%d) Experience: %I64d + %d",    // #error gObj[iIndex].X -> gObj[iIndex].Y
    ...
    if ((gObj[iIndex].m_PlayerData->Experience + iAddExp) < gObj[iIndex].m_PlayerData->NextExp) {
        ...
        if (g_ConfigRead.data.reset.iBlockLevelUpPointAfterResets == -1 ||
            gObj[iIndex].m_PlayerData->m_iResets < g_ConfigRead.data.reset.iBlockLevelUpPointAfterResets) {
            if (gObj[iIndex].Class == CLASS_DARKLORD || gObj[iIndex].Class == CLASS_MAGUMSA ||
                gObj[iIndex].Class == CLASS_RAGEFIGHTER || gObj[iIndex].Class == CLASS_GROWLANCER) {
    ...
    for (int i = 0; i < MAX_BLOOD_CASTLE_SUB_BRIDGE; i++) {
        if (this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex != -1) {
            if (gObjIsConnected(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex) == FALSE) {
                ...
                if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].MapNumber !=
                    this->GetBridgeMapNumber(iBridgeIndex)) //season3 changed
                {
                    this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex = -1;
                }
            }
...
void CBloodCastle::BlockCastleEntrance(int iBridgeIndex) {
    ...
    for (int i = ::g_btCastleEntranceMapXY[iBridgeIndex].btStartX;
         i <= ::g_btCastleEntranceMapXY[iBridgeIndex].btEndX; i++) {
        for (int j = ::g_btCastleEntranceMapXY[iBridgeIndex].btStartY;
             j <= ::g_btCastleEntranceMapXY[iBridgeIndex].btEndY; j++) {
            int iMapNumber = this->GetBridgeMapNumber(iBridgeIndex); //season3 add-on
...
void CBloodCastle::BlockCastleBridge(int iBridgeIndex) {
    ...
    for (int i = ::g_btCastleBridgeMapXY[iBridgeIndex].btStartX;
         i <= ::g_btCastleBridgeMapXY[iBridgeIndex].btEndX; i++) {
        for (int j = ::g_btCastleBridgeMapXY[iBridgeIndex].btStartY;
             j <= ::g_btCastleBridgeMapXY[iBridgeIndex].btEndY; j++) {
            int iMapNumber = this->GetBridgeMapNumber(iBridgeIndex); //season3 add-on
...
void CBloodCastle::BlockCastleDoor(int iBridgeIndex) {
    ...
    for (int x = 0; x < 3; x++) {
        for (int y = ::g_btCastleDoorMapXY[iBridgeIndex][x].btStartX;
             y <= ::g_btCastleDoorMapXY[iBridgeIndex][x].btEndX; y++) {
            for (int z = ::g_btCastleDoorMapXY[iBridgeIndex][x].btStartY;
                 z <= ::g_btCastleDoorMapXY[iBridgeIndex][x].btEndY; z++) {
                int iMapNumber = this->GetBridgeMapNumber(iBridgeIndex); //season3 add-on
    ...
    for (int i = g_ConfigRead.server.GetObjectMaxMonster(); i < g_ConfigRead.server.GetObjectMax(); i++) {
        ...
        if (gObj[i].MapNumber == iMapNumber) //season3 changed
        {
            if (gObj[i].Connected > PLAYER_LOGGED) {
                ...
                g_Log.Add("[Blood Castle][Bug Tracer] SendCastleBridgeBlockInfo-> Bridge:%d/Live:%d, (%d,%d,%d,%d)",
                          iBridgeIndex + 1, bLive, lpMsgBody[0].btX, lpMsgBody[0].btY, lpMsgBody[1].btX,
                          lpMsgBody[1].btY);
            }
        }
    }
            ...
            if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].Connected > PLAYER_LOGGED) {
                if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].m_cBloodCastleIndex != -1) {
                    if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].m_cBloodCastleSubIndex != -1) {
                        IOCP.DataSend(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex, (UCHAR * ) & pNotice,
                                      pNotice.h.size);
                    }
                }
            }
    ...
    for (int i = 0; i < MAX_BLOOD_CASTLE_SUB_BRIDGE; i++) {
        if (this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex != -1) {
            if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].Connected > PLAYER_LOGGED) {
                if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].m_cBloodCastleIndex != -1) {
                    if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].m_cBloodCastleSubIndex != -1) {
                        TNotice::MakeNoticeMsgEx(&pNotice, 0, Lang.GetText(0, 69), iBridgeIndex + 1,
                                                 this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iEXP);
                        IOCP.DataSend(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex, (UCHAR * ) & pNotice,
                                      pNotice.h.size);
                    }
                }
    ...
    for (int i = 0; i < MAX_BLOOD_CASTLE_SUB_BRIDGE; i++) {
        if (this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex != -1) {
            if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].Connected > PLAYER_LOGGED) {
                if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].m_cBloodCastleIndex != -1) {
                    if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].m_cBloodCastleSubIndex != -1) {
                        IOCP.DataSend(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex, (UCHAR * ) & pMsg,
                                      pMsg.h.size);
                    }
                }
            }
        ...
        if (gObj[iIndex].pInventory[x].IsItem() == TRUE) {
            if (gObj[iIndex].pInventory[x].m_Type == ITEMGET(13, 19)) {
                ...
                if (BC_WEAPON_LEVEL_RANGE(iLEVEL) != FALSE) {
                    ...
                    g_Log.Add(
                            "[Blood Castle] Force (Account:%s, Name:%s) to Delete Angel King's Weapon (%d) [Serial:%I64d]",
                ...
                if (BC_WEAPON_LEVEL_RANGE(iLEVEL) != FALSE) {
                    ...
                    if (BC_MAP_RANGE(gObj[iIndex].MapNumber) != FALSE) {
                        ...
                        if (this->m_BridgeData[iBC_INDEX].m_nBC_QUESTITEM_SERIAL != -1) {
                            if (this->m_BridgeData[iBC_INDEX].m_nBC_QUESTITEM_SERIAL ==
                        ...
                        g_Log.Add(
                                "[Blood Castle] Force (Account:%s, Name:%s) to Drop Angel King's Weapon (%d) [Serial:%I64d-%I64d]",
                                gObj[iIndex].AccountID, gObj[iIndex].Name, iLEVEL,
                                this->m_BridgeData[iBC_INDEX].m_nBC_QUESTITEM_SERIAL,
                                gObj[iIndex].pInventory[x].m_Number);

                    } else {
                        g_Log.Add(
                                "[Blood Castle] Force (Account:%s, Name:%s) to Drop Angel King's Weapon (%d) [Serial:%I64d]",
                                gObj[iIndex].AccountID, gObj[iIndex].Name, iLEVEL,
                                gObj[iIndex].pInventory[x].m_Number);
                    }
                }
        ...
        case 2:
            if (gObj[iIndex].PartyNumber >= 0) {
                for (int i = 0; i < MAX_BLOOD_CASTLE_SUB_BRIDGE; i++) {
                    ...
                    if (gObj[iIndex].PartyNumber ==
                        gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].PartyNumber) {
                        if (BC_MAP_RANGE(gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].MapNumber) !=
                            FALSE) {
    ...
    if (this->m_BridgeData[iBridgeIndex].m_iMISSION_SUCCESS != -1) {
        ...
        for (int i = 0; i < MAX_BLOOD_CASTLE_SUB_BRIDGE; i++) {
            ...
            if ((gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].PartyNumber != -1 &&
                 gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].PartyNumber ==
                 this->m_BridgeData[iBridgeIndex].m_iExtraEXP_Kill_Door_Party) ||
                this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex ==
                this->m_BridgeData[iBridgeIndex].m_iExtraEXP_Kill_Door_Index) {
            ...
            if ((gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].PartyNumber != -1 &&
                 gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].PartyNumber ==
                 this->m_BridgeData[iBridgeIndex].m_iExtraEXP_Kill_Statue_Party) ||
                this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex ==
                this->m_BridgeData[iBridgeIndex].m_iExtraEXP_Kill_Statue_Index) {
                iADD_EXP += ::g_iBC_Add_Exp[iBridgeIndex].unk4;
            }

            if ((gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].PartyNumber != -1 &&
                 gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].PartyNumber ==
                 this->m_BridgeData[iBridgeIndex].m_iExtraEXP_Win_Quest_Party) ||
                this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex ==
                this->m_BridgeData[iBridgeIndex].m_iExtraEXP_Win_Quest_Index) {
                iADD_EXP += ::g_iBC_Add_Exp[iBridgeIndex].unk8;
            }

            switch (this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iUserState) {
                case 0:
                    iADD_EXP += (int) this->m_BridgeData[iBridgeIndex].m_i64_BC_REMAIN_MSEC / 1000 *
                                ::g_iBC_Add_Exp[iBridgeIndex].unkC;
                    iREWARD_EXP = this->CalcSendRewardEXP(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex,
                                                          iADD_EXP);
                    iREWARD_ZEN = this->CalcSendRewardZEN(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex,
                                                          ::g_iQuestWinExpendZEN[iBridgeIndex].SpecialCharacter);
                    iREWARD_SCR = ::g_iBC_EventScore[iBridgeIndex].unk0;
                    this->SendRewardScore(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex, iREWARD_SCR,
                                          iLEFT_TIME, 0);

                    g_Log.Add(
                            "[Blood Castle] (%d) Quest Complete Rewarded (Account:%s, Name:%s [State:%d], Exp:%d, ExtExp:%d, Zen:%d, Score:%d, LeftTime:%d, MapNumber:%d)",
                            ...
                            iREWARD_EXP, iREWARD_ZEN, iREWARD_SCR, iLEFT_TIME,
                ...
                case 2:
                    ...
                    iREWARD_EXP = this->CalcSendRewardEXP(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex,
                                                          iADD_EXP);
                    iREWARD_ZEN = this->CalcSendRewardZEN(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex,
                                                          ::g_iQuestWinExpendZEN[iBridgeIndex].NormalCharacter);
            ...
            pMsg.bWinner = true;
            pMsg.btType = -1;
            memcpy(pMsg.m_stBCCharScore[0].CharName, gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].Name,
                   MAX_ACCOUNT_LEN);
            pMsg.m_stBCCharScore[0].iEXP = iREWARD_EXP;
            pMsg.m_stBCCharScore[0].iZEN = iREWARD_ZEN;
            pMsg.m_stBCCharScore[0].iSCORE = iREWARD_SCR;
            PHeadSetB((LPBYTE) & pMsg.PHeader, 0x93,
                      sizeof(GCS_BC_GIVE_REWARD) - (sizeof(ST_BC_SCORE) * (MAX_BLOOD_CASTLE_SUB_BRIDGE - 1)));

            IOCP.DataSend(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex, (UCHAR * ) & pMsg,
                          pMsg.PHeader.uSize);
            g_QuestExpProgMng.ChkUserQuestTypeEventMap(QUESTEXP_ASK_BLOODCASTLE_CLEAR,
                                                       &gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex],
                                                       gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].m_cBloodCastleIndex,
                                                       0);
        }
...
void CBloodCastle::GiveReward_Fail(int iBridgeIndex) {
    ...
    for (int i = 0; i < MAX_BLOOD_CASTLE_SUB_BRIDGE; i++) {
        ...
        this->SendRewardScore(this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex,
                              ::g_iBC_EventScore_Fail[iBridgeIndex], 0, 0);
    ...
    if (gObj[iIndex].Type == OBJ_USER) {
        while (iCAL_EXP > 0) {
            if (iCAL_EXP > 0) {
                ...
                iCAL_EXP = (iCAL_EXP) *
                           this->m_BridgeData[gObj[iIndex].m_cBloodCastleIndex].m_iBC_REWARD_EXP; //season 4.5 add-on
                iRET_EXP = (iCAL_EXP);
...
void CBloodCastle::DropReward(int iIndex) {
    ...
    switch (gObj[iIndex].m_cBloodCastleIndex) {
        case 0:
            g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_BC1, iIndex, GC_STORAGE_CHARACTER,
                                            GC_REWARD_BLOOD_CASTLE, 30);
            break;
        case 1:
            g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_BC2, iIndex, GC_STORAGE_CHARACTER,
                                            GC_REWARD_BLOOD_CASTLE, 30);
            break;
        case 2:
            g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_BC3, iIndex, GC_STORAGE_CHARACTER,
                                            GC_REWARD_BLOOD_CASTLE, 30);
            break;
        case 3:
            g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_BC4, iIndex, GC_STORAGE_CHARACTER,
                                            GC_REWARD_BLOOD_CASTLE, 30);
            break;
        case 4:
            g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_BC5, iIndex, GC_STORAGE_CHARACTER,
                                            GC_REWARD_BLOOD_CASTLE, 30);
            break;
        case 5:
            g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_BC6, iIndex, GC_STORAGE_CHARACTER,
                                            GC_REWARD_BLOOD_CASTLE, 30);
            break;
        case 6:
            g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_BC7, iIndex, GC_STORAGE_CHARACTER,
                                            GC_REWARD_BLOOD_CASTLE, 30);
            break;
        case 7:
            g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_BC8, iIndex, GC_STORAGE_CHARACTER,
                                            GC_REWARD_BLOOD_CASTLE, 30);
            break;
...
void CBloodCastle::SetMonsterKillCount(int iBridgeIndex) {
    ...
    g_Log.Add(
            "[Blood Castle] (%d) Monster Kill Count Set - Monster:%d, Current Monster:%d, USER TOT:%d, LIVE:%d, DEAD:%d",
...
bool CBloodCastle::CheckMonsterKillCount(int iBridgeIndex) {
    ...
    if (this->m_BridgeData[iBridgeIndex].m_iBC_MONSTER_KILL_COUNT >=
        this->m_BridgeData[iBridgeIndex].m_iBC_MONSTER_MAX_COUNT) {
...
bool CBloodCastle::CheckBossKillCount(int iBridgeIndex) {
    ...
    if (this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_KILL_COUNT >=
        this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_MAX_COUNT) {
        g_Log.Add(
                "[Blood Castle][Bug Tracker] (%d) All Boss Monster Kill Success(Max Boss Kill Count:%d / Boss Kill Count:%d)",
        ...
        if (this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex != -1) {
                ...
                this->GetBridgeMapNumber(iBridgeIndex)) //season3 changed
            {
                if (gObj[this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex].Connected > PLAYER_LOGGED) {
                    ...
                    g_Log.Add("error-L3 : [Blood Castle] (%d) Connection Closed UserIndex:%d, SubIndex:%d",
                              iBridgeIndex + 1, this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iIndex, i);
                }
            } else {
        ...
        for (int x = 0; x < INVENTORY_SIZE; x++) {
            if (gObj[iIndex].pInventory[x].IsItem() == TRUE) {
                if (gObj[iIndex].pInventory[x].m_Type == ITEMGET(13, 19)) {
                    ...
                    if (BC_WEAPON_LEVEL_RANGE(iLEVEL) != FALSE) {
                        if (this->m_BridgeData[iBridgeIndex].m_nBC_QUESTITEM_SERIAL != -1) {
                            if (this->m_BridgeData[iBridgeIndex].m_nBC_QUESTITEM_SERIAL ==
                                gObj[iIndex].pInventory[x].m_Number) {
...
BOOL CBloodCastle::DropItemDirectly(int iBridgeIndex, int iIndex, int iItemType, int iItemPos) {
    if (BC_MAP_RANGE(this->GetBridgeMapNumber(iBridgeIndex)) == FALSE) {
        g_Log.Add("[Blood Castle] [%s][%s] DropItemDirectly() failed (iBridgeIndex wrong - %d)", gObj[iIndex].AccountID,
                  gObj[iIndex].Name, iBridgeIndex);
        return FALSE;
    }
    ...
    if (MapC[map_num].ItemDrop(type, level, dur, gObj[iIndex].X, gObj[iIndex].Y, Option1, Option2, Option3, NOption,
                               SOption, item_number, aAntiLootIndex, PetLevel, PetExp, ItemEffectEx, SocketOption,
                               SocketIndex, 0) == TRUE) {
        ::gObjInventoryDeleteItem(iIndex, iItemPos);
        pResult.Result = TRUE;

        g_Log.Add(
                "[%s][%s][%d]%d/%d Throw away Serial:%I64d [%s][%d][%d][%d][%d][%d] dur:[%d] Ex:[%d,%d,%d,%d,%d,%d,%d] Set:[%d] 380:[%d] HO:[%d,%d] E:[%d]",
                gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].MapNumber,
                gObj[iIndex].X, gObj[iIndex].Y, s_num, szItemName, type, level, Option1, Option2, Option3, (int) dur,
                NewOption[0],
...
bool CBloodCastle::CheckUserHaveUlimateWeapon(int iIndex) {
    ...
    for (int x = 0; x < INVENTORY_SIZE; x++) {
        if (gObj[iIndex].pInventory[x].IsItem() == TRUE) {
            if (gObj[iIndex].pInventory[x].m_Type == ITEMGET(0, 19) ||
                gObj[iIndex].pInventory[x].m_Type == ITEMGET(5, 10) ||
                gObj[iIndex].pInventory[x].m_Type == ITEMGET(4, 18)) {
                bRetVal = true;
                break;
            }
        }
...
bool CBloodCastle::CheckWinnerValid(int iBridgeIndex) {
    if (!BC_BRIDGE_RANGE(iBridgeIndex)) {
        g_Log.Add(
                "[Blood Castle] (%d) CBloodCastle::CheckWinnerValid() - !CHECK_LIMIT(iBridgeIndex, MAX_BLOODCASTLE_BRIDGE_COUNT)",
                iBridgeIndex + 1);
    ...
    if (this->m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX == -1) {
        g_Log.Add(
                "[Blood Castle] (%d) CBloodCastle::CheckWinnerValid() - m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX == -1",
                iBridgeIndex + 1);
    ...
    if (!gObjIsConnected(this->m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX)) {
        g_Log.Add(
                "[Blood Castle] (%d) CBloodCastle::CheckWinnerValid() - !gObjIsConnected(m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX)",
                iBridgeIndex + 1);

        return false;
    }

    if (gObj[this->m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX].m_cBloodCastleIndex == -1 ||
        gObj[this->m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX].m_cBloodCastleSubIndex == -1 ||
        gObj[this->m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX].m_cBloodCastleIndex != iBridgeIndex) {
        g_Log.Add(
                "[Blood Castle] (%d) CBloodCastle::CheckWinnerValid() - (gObj[m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX].m_cBloodCastleIndex == -1) ...",
                iBridgeIndex + 1);
    ...
    if (!BC_MAP_RANGE(gObj[this->m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX].MapNumber)) {
        g_Log.Add(
                "[Blood Castle] (%d) CBloodCastle::CheckWinnerValid() - !CHECK_BLOODCASTLE(gObj[m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX].MapNumber)",
                iBridgeIndex + 1);
...
void CBloodCastle::FixUsersPlayStateWin(int iBridgeIndex) {
    ...
    if (this->m_BridgeData[iBridgeIndex].m_iMISSION_SUCCESS != -1) {
        for (int i = 0; i < MAX_BLOOD_CASTLE_SUB_BRIDGE; i++) {
            ...
            switch (this->m_BridgeData[iBridgeIndex].m_UserData[i].m_iUserState) {
                case 0:
                    if (ObjectMaxRange(lpObj->PartyNumber) && lpObj->PartyNumber ==
                                                              gObj[this->m_BridgeData[iBridgeIndex].m_iBC_COMPLETE_USER_INDEX].PartyNumber) {
...
bool CBloodCastle::NpcAngelKing(LPOBJ lpNpc, LPOBJ lpObj) {
    ...
    if (iITEM_LEVEL = iITEM_LEVEL = CHECK_LIMIT(this->CheckQuestItem(lpObj->m_Index), 3)) {
        ...
        if (this->m_bBC_RESTRICT_FINISH_ENABLE == true) {
            if ((this->m_iBC_RESTRICT_FINISH_TIME * 1000) <
                (int) this->m_BridgeData[iBLOODCASTLE_INDEX].m_i64_BC_REMAIN_MSEC) {
        ...
        g_Log.Add("[Blood Castle] (%d) Blood Castle Quest Succeed Result -> Destroy Saint Status [%s][%s]",
                  iBLOODCASTLE_INDEX + 1,
                  this->m_BridgeData[iBLOODCASTLE_INDEX].m_szKill_Status_AccountID,    // #error Correct this
        ...
        if (this->SetBridgeWinner(iBLOODCASTLE_INDEX, lpObj->m_Index) == TRUE) {
            ...
            if (this->CheckPartyExist(lpObj->m_Index) == FALSE) {
                ...
                GSProtocol.GCServerCmd(lpObj->m_Index, 1, 0x17, 0);
                g_Log.Add(
                        "[Blood Castle] (%d) (Account:%s, Name:%s) Succeed Blood Castle Quest - More Party to register",
                        iBLOODCASTLE_INDEX + 1, lpObj->AccountID, lpObj->Name);
            }
        } else {
...
void CBloodCastle::KillMonsterProc(int iBridgeIndex, LPOBJ lpMonsterObj) {
    ...
    if (lpMonsterObj->Class == 89 || lpMonsterObj->Class == 95 || lpMonsterObj->Class == 112 ||
        lpMonsterObj->Class == 118 || lpMonsterObj->Class == 124 || lpMonsterObj->Class == 130 ||
        lpMonsterObj->Class == 143 || lpMonsterObj->Class == 433) {
        this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_KILL_COUNT++;
    } else {
        this->m_BridgeData[iBridgeIndex].m_iBC_MONSTER_KILL_COUNT++;
    }
    ...
    if (this->CheckMonsterKillCount(iBridgeIndex) != false) {
        if (this->m_BridgeData[iBridgeIndex].m_bBC_MONSTER_KILL_COMPLETE == false) {
            ...
            g_Log.Add("[Blood Castle] (%d) All of the Monster Terminated -> %d", iBridgeIndex + 1,
                      this->m_BridgeData[iBridgeIndex].m_iBC_MONSTER_KILL_COUNT);

            this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_MAX_COUNT =
                    this->GetCurrentLiveUserCount(iBridgeIndex) * 2;
            this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_KILL_COUNT = 0;
    ...
    if (this->m_BridgeData[iBridgeIndex].m_bBC_MONSTER_KILL_COMPLETE != false) {
        if (this->CheckBossKillCount(iBridgeIndex) != false) {
            if (this->m_BridgeData[iBridgeIndex].m_bBC_BOSS_MONSTER_KILL_COMPLETE == false) {
                ...
                g_Log.Add("[Blood Castle] (%d) All of the Boss Monster Terminated -> %d", iBridgeIndex + 1,
                          this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_KILL_COUNT);
            }
...
void CBloodCastle::DestroyCastleDoor(int iBridgeIndex, LPOBJ lpDoorObj) {
    ...
    if (TopHitUser != -1) {
        ...
        g_QuestExpProgMng.ChkUserQuestTypeEventMap(QUESTEXP_ASK_BLOODCASTLE_DOOR_KILL, &gObj[TopHitUser],
                                                   this->GetBridgeIndex(gObj[TopHitUser].MapNumber), 1);

        g_Log.Add("[Blood Castle] (%d) Door Terminated -> %d [%s][%s]", iBridgeIndex + 1,
                  this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_KILL_COUNT, gObj[TopHitUser].AccountID,
                  gObj[TopHitUser].Name);
    } else {
        this->SendNoticeMessage(iBridgeIndex, Lang.GetText(0, 73));
        g_Log.Add("[Blood Castle] (%d) Door Terminated -> %d)", iBridgeIndex + 1,
                  this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_KILL_COUNT);
    }
    ...
    for (int n = 0; n < MAX_BLOOD_CASTLE_SUB_BRIDGE; n++) {
        if (this->m_BridgeData[iBridgeIndex].m_UserData[n].m_iIndex != -1) {
            ...
            if (this->m_BridgeData[iBridgeIndex].m_iExtraEXP_Kill_Door_Party ==
                gObj[this->m_BridgeData[iBridgeIndex].m_UserData[n].m_iIndex].PartyNumber) {
                ...
                g_QuestExpProgMng.ChkUserQuestTypeEventMap(QUESTEXP_ASK_BLOODCASTLE_DOOR_KILL, tmp_user, BridgeIndex,
                                                           1);
            }
        }
    }
...
void CBloodCastle::DestroySaintStatue(int iBridgeIndex, LPOBJ lpStatueObj) {
    ...
    if (TopHitUser != -1) {
        ...
        g_Log.Add("[Blood Castle] (%d) a stone statue Of Saint Terminated -> %d [%s][%s]", iBridgeIndex + 1,
                  this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_KILL_COUNT, gObj[TopHitUser].AccountID,
                  gObj[TopHitUser].Name);
    } else {
        this->SendNoticeMessage(iBridgeIndex, Lang.GetText(0, 306));
        g_Log.Add("[Blood Castle] (%d) a stone statue Of Saint Terminated -> %d", iBridgeIndex + 1,
                  this->m_BridgeData[iBridgeIndex].m_iBC_BOSS_MONSTER_KILL_COUNT);
    }
    ...
    ItemSerialCreateSend(lpStatueObj->m_Index, iMapNumber, lpStatueObj->X, lpStatueObj->Y, type, level, 0, 0, 0, 0,
                         TopHitUser, 0, 0, 0, 0, 0);

    this->m_BridgeData[iBridgeIndex].m_btBC_QUEST_ITEM_NUMBER = level;

    g_Log.Add("[Blood Castle] (%d) Ultimate Weapon Dropped -> (%s)", iBridgeIndex + 1,
              (level != 0) ? ((level == 1) ? "Sword" : "Crossbow") : "Staff");
...
bool CBloodCastle::SetPosMonster(int iBridgeIndex, int iMonsterIndex, int iPosNum, int iMonsterClass) {
    ...
    if (this->GetPosition(lpPos, lpObj->MapNumber, lpObj->X, lpObj->Y) == FALSE) {
        g_Log.Add("[Blood Castle] [Invalid Location]: MAP: %d X: %d Y: %d POSNUM: %d", lpObj->MapNumber, lpPos->m_X,
                  lpPos->m_Y, iPosNum);
        return FALSE;
    }

...
void CEledoradoEvent::ClearMonster() {
    ...
    for (std::map<int, ELEDORADO_MONSTER_INFO>::iterator It = this->m_mapMonsterInfo.begin();
...
void CEledoradoEvent::RegenTitan() {
    ...
    for (int i = 0; i < It->second.m_Count; i++) {
        ...
        this->GetBoxPosition(MapNumber, this->m_BossTitanMapX - 4, this->m_BossTitanMapY - 4, this->m_BossTitanMapX + 4,
                             this->m_BossTitanMapY + 4, gObj[result].X, gObj[result].Y);
...
void CEledoradoEvent::RegenDevilLizardKing() {
    ...
    for (int i = 0; i < It->second.m_Count; i++) {
        ...
        this->GetBoxPosition(MapNumber, this->m_BossDevilLizardKingMapX - 4, this->m_BossDevilLizardKingMapY - 4,
                             this->m_BossDevilLizardKingMapX + 4, this->m_BossDevilLizardKingMapY + 4, gObj[result].X,
                             gObj[result].Y);

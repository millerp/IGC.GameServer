...
public:
    ...
    int RunningSkill_MLS(OBJECTSTRUCT *lpObj, int aTargetIndex, CMagicInf *lpMagic, BOOL bCombo, BYTE x, BYTE y,
                         BYTE aTargetPos);
    ...
    void MLS_SkillStrengthenDesruction(OBJECTSTRUCT *lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex,
                                       int isCombo);
    ...
    void MLS_SkillAreaMonsterAttack(int aIndex, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex, int aDistance,
                                    BOOL bPVP, int nSuccessRate, int nDelay);
    ...
    void MLS_SkillStrengthenDragonRoar(int aIndex, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex, int aDistance,
                                       BOOL bPVP, int nDelay);
    ...
    void MLS_SkillSkillfulDesruction(OBJECTSTRUCT *lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex,
                                     BOOL isCombo);

    void
    MLS_SkillMasteryDesruction(OBJECTSTRUCT *lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex, BOOL isCombo);
    ...
    void
    MLS_SkillStrengthenElectricSpark(int aIndex, CMagicInf *lpMagic, BYTE x, BYTE y, BYTE TargetPos, int aTargetIndex);

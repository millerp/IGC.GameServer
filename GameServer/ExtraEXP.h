...
public: // like this got it? yup
    void LoadFile(
            LPSTR file); // LPSTR is a string and file is name of argument. we must put the function here in class header so we can access it from anywhere nderstad? yup a

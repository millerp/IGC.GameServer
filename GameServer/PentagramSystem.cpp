...
bool CPentagramSystem::LoadDropScript(char *pchFileName) {
    ...
    if (res.status != pugi::status_ok) {
        g_Log.MsgBox("[PentagramSystem] PentagramSystem Drop Script file Load failed. (%s) (%s)", pchFileName,
                     res.description());
        return false;
    }
...
bool CPentagramSystem::LoadJewelOutRate(char *pchFileName) {
    ...
    if (res.status != pugi::status_ok) {
        g_Log.MsgBox("[PentagramSystem] PentagramSystem JewelOutRate Script file Load failed. (%s) (%s)", pchFileName,
                     res.description());
        return false;
    }
...
bool CPentagramSystem::LoadPentagramOptionScript(char *pchFileName) {
    ...
    if (res.status != pugi::status_ok) {
        g_Log.MsgBox("[PentagramSystem] PentagramSystem PentagramOption Script file Load failed. (%s) (%s)",
                     pchFileName, res.description());
        return false;
    }
    ...
    for (pugi::xml_node errtel = optionsetting.child("Errtel"); errtel; errtel = errtel.next_sibling()) {
        ...
        memcpy(&this->m_PentagramItemOptionEnableNeed[iValueCount], &PentagramItemOptionEnableNeed,
               sizeof(PentagramItemOptionEnableNeed));
        iValueCount++;
    }
    ...
    for (pugi::xml_node socket = socketprobabilityrate.child("Socket"); socket; socket = socket.next_sibling()) {
        ...
        memcpy(&this->m_PentagramSocketRateByGrade[iValueCount], &PentagramSocketRateByGrade,
               sizeof(PentagramSocketRateByGrade));
        iValueCount++;
    }
...
bool CPentagramSystem::IsPentagramJewel(int ItemCode) {
    ...
    for (int i = 0; i < 250; i++) {
        if (g_PentagramMixSystem.m_JewelItemOptionData[i].PentagramJewel_Type &&
            g_PentagramMixSystem.m_JewelItemOptionData[i].PentagramJewel_Index) {
            if (ItemCode == ITEMGET(g_PentagramMixSystem.m_JewelItemOptionData[i].PentagramJewel_Type,
                                    g_PentagramMixSystem.m_JewelItemOptionData[i].PentagramJewel_Index)) {
                return true;
            }
        }
                            ...
                            if (btRank1OptionNum != 0x0F) {
                                for (int k = 0; k < 250; k++) {
                                    if (g_PentagramMixSystem.m_JewelItemOptionData[k].JewelIndex >= 0 &&
                                        ...
                                        btRank1OptionNum ==
                                        g_PentagramMixSystem.m_JewelItemOptionData[k].RankOptionNum) {
            ...
            for (int iOption = 0; iOption < 7; iOption++) {
                ...
                for (int iOptionCount = 0; iOptionCount < 10; iOptionCount++) {
                    if (this->m_PentagramItemOptionEnableNeed[iOptionCount].OptionNum == iOptionNum) {
                        ...
                        for (int iEnableNeedCount = 0; iEnableNeedCount < 3 &&
                                                       this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelKind[iEnableNeedCount] !=
                                                       -1; iEnableNeedCount++) {
                            if (lpItemData->m_SocketOption[this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelKind[iEnableNeedCount]] >=
                                0xFE) {
                                bNotMatch = true;
                                break;
                            }
                            ...
                            for (int l = 0; l < 250; l++) {
                                if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btJewelIndex ==
                                    lpItemData->m_SocketOption[this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelKind[iEnableNeedCount]]) {
                                    if (this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelRank[iEnableNeedCount] ==
                                        1) {
                                        if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank1Level >= 15 ||
                                            lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank1Level <
                                            this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelLevel[iEnableNeedCount]) {
                                            bEnableNeed = false;
                                            bNotMatch = true;
                                        } else {
                                            bEnableNeed = true;
                                    ...
                                    if (this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelRank[iEnableNeedCount] ==
                                        ...
                                        if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank2Level >= 15 ||
                                            lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank2Level <
                                            this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelLevel[iEnableNeedCount]) {
                                            bEnableNeed = false;
                                            bNotMatch = true;
                                        } else {
                                    ...
                                    if (this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelRank[iEnableNeedCount] ==
                                        ...
                                        if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank3Level >= 15 ||
                                            lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank3Level <
                                            this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelLevel[iEnableNeedCount]) {
                                            bEnableNeed = false;
                                            bNotMatch = true;
                                        } else {
                                    ...
                                    if (this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelRank[iEnableNeedCount] ==
                                        ...
                                        if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank4Level >= 15 ||
                                            lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank4Level <
                                            this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelLevel[iEnableNeedCount]) {
                                            bEnableNeed = false;
                                            bNotMatch = true;
                                        } else {
                                    ...
                                    if (this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelRank[iEnableNeedCount] ==
                                        ...
                                        if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank5Level >= 15 ||
                                            lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[l].btRank5Level <
                                            this->m_PentagramItemOptionEnableNeed[iOptionCount].Need_ErrtelLevel[iEnableNeedCount]) {
                                            bEnableNeed = false;
                                            bNotMatch = true;
                                        } else {
...
int CPentagramSystem::AttributeMonsterItemDrop(LPOBJ lpObj) {
            ...
            if (iRandNum >= this->m_ServerAttributeDefine[i].FireRate) {
                if (iRandNum < iFireRate || iRandNum >= iWaterRate + iFireRate) {
                    if (iRandNum < iWaterRate + iFireRate || iRandNum >= iEarthRate + iWaterRate + iFireRate) {
                        if (iRandNum < iEarthRate + iWaterRate + iFireRate ||
                            iRandNum >= iWindRate + iEarthRate + iWaterRate + iFireRate) {
                            if (iRandNum >= iWindRate + iEarthRate + iWaterRate + iFireRate &&
                                iRandNum < iDarkRate + iWindRate + iEarthRate + iWaterRate + iFireRate) {
                                iMainAttribute = 5;
                            }
                        } else {
                            iMainAttribute = 4;
            ...
            if (iRandNum >= iItem1Rate) {
                if (iRandNum < iItem1Rate || iRandNum >= iItem2Rate + iItem1Rate) {
                    if (iRandNum < iItem2Rate + iItem1Rate || iRandNum >= iItem3Rate + iItem2Rate + iItem1Rate) {
                        if (iRandNum < iItem3Rate + iItem2Rate + iItem1Rate ||
                            iRandNum >= iItem4Rate + iItem3Rate + iItem2Rate + iItem1Rate) {
                            if (iRandNum < iItem4Rate + iItem3Rate + iItem2Rate + iItem1Rate ||
                                iRandNum >= iItem5Rate + iItem4Rate + iItem3Rate + iItem2Rate + iItem1Rate) {
                                if (iRandNum >= iItem5Rate + iItem4Rate + iItem3Rate + iItem2Rate + iItem1Rate &&
                                    iRandNum <
                                    iItem6Rate + iItem5Rate + iItem4Rate + iItem3Rate + iItem2Rate + iItem1Rate) {
                                    bMakeItem = true;
    ...
    if (bMakeItem == true) {
        ...
        ItemSerialCreateSend(lpObj->m_Index, lpObj->MapNumber, lpObj->X, lpObj->Y, ItemNumber, 0,
                             ItemGetDurability(ItemNumber, 0, 0, 0), 0, 0, 0, MaxHitUser, 0, 0, 0, 0,
                             iMainAttribute | 0x10);
        g_Log.Add("[PentagramSystem] Pentagram Item Drop [%s]: [%s][%s] (type:%d)", lpObj->Name, lpUser->AccountID,
                  lpUser->Name, ItemNumber);
        ...
        for (int i = 0; i < 13; i++) {
            if (this->m_PentagramItemOpenSocketRate[i].SocketCount != iSocketCount) {
                ...
                if (iSlotCountRand < this->m_PentagramItemOpenSocketRate[i].SocketOpenRate + iSocketAddRate) {
                    ...
                    for (int j = 0; j < 13; ++j) {
                        if (iSocketSlotCount == this->m_PentagramItemOpenSocketRate[j].SocketCount &&
                            iSlotSetRand < this->m_PentagramItemOpenSocketRate[j].SocketOpenSet + iSetAddRate) {
                            ...
                            if (this->m_PentagramItemOpenSocketRate[j].Slot_3 == 10000) {
                                ...
                                if (iSlotNoRand >= this->m_PentagramItemOpenSocketRate[j].Slot_3 + iSlotNumAddRate ||
                                    bSlotOpen) {
                                    iSlot_3 = 0;
                            ...
                            if (this->m_PentagramItemOpenSocketRate[j].Slot_4 == 10000) {
                                ...
                                if (iSlotNoRand >= this->m_PentagramItemOpenSocketRate[j].Slot_4 + iSlotNumAddRate ||
                                    bSlotOpen) {
                                    iSlot_4 = 0;
                            ...
                            if (this->m_PentagramItemOpenSocketRate[j].Slot_5 == 10000)
                                ...
                                iSlot_5 =
                                        iSlotNoRand < this->m_PentagramItemOpenSocketRate[j].Slot_5 + iSlotNumAddRate &&
                                        !bSlotOpen;
                            goto END_LOOP2;
                        }
...
bool
CPentagramSystem::MakePentagramSocketSlot(CItem *lpItemData, BYTE btSocketSlot1, BYTE btSocketSlot2, BYTE btSocketSlot3,
                                          BYTE btSocketSlot4, BYTE btSocketSlot5) {
    if (!lpItemData) {
        return false;
    }
...
bool
CPentagramSystem::ClearPentagramSocketSlot(int aIndex, int iInventoryPos, CItem *lpTargetItem, BYTE btSocketSlotIndex) {
    if (!lpTargetItem) {
        return false;
    }
...
bool CPentagramSystem::SetPentagramSocketSlot(CItem *lpTargetItem, BYTE bt1RankOptionNum, BYTE bt1RankLevel,
                                              BYTE bt2RankOptionNum, BYTE bt2RankLevel, BYTE bt3RankOptionNum,
                                              BYTE bt3RankLevel, BYTE bt4RankOptionNum, BYTE bt4RankLevel,
                                              BYTE bt5RankOptionNum, BYTE bt5RankLevel, BYTE curRank) {
    if (!lpTargetItem) {
        return false;
    }
    ...
    if (iSwitchType == 1) {
        for (int i = 0; i < 5; i++) {
            if (lpSourceItem->m_SocketOption[i] < 0xFE) {
                for (int j = 0; j < 250; j++) {
                    if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[j].btJewelIndex ==
                        lpSourceItem->m_SocketOption[i]) {
                ...
                for (int iJewelIndex = 0; iJewelIndex < 250; iJewelIndex++) {
                    ...
                    if (!bIndexExist) {
                        ...
                        this->AddPentagramJewelInfo(aIndex, 1, iJewelIndex, iItemType, iItemIndex, iMainAttribute,
                                                    iJewelLevel,
                                                    iRank1OptionNum, iRank1Level, iRank2OptionNum, iRank2Level,
                                                    iRank3OptionNum, iRank3Level,
        ...
        for (int i = 0; i < 5; i++) {
            if (lpSourceItem->m_SocketOption[i] < 0xFE) {
                for (int j = 0; j < 250; j++) {
                    if (lpObj->m_PlayerData->m_PentagramJewelInfo_Warehouse[j].btJewelIndex ==
                        lpSourceItem->m_SocketOption[i]) {
                ...
                for (int iJewelIndex = 0; iJewelIndex < 250; iJewelIndex++) {
                    ...
                    if (!bIndexExist) {
                        lpSourceItem->m_BonusSocketOption = iMainAttribute;
                        lpSourceItem->m_SocketOption[i] = iJewelIndex;
                        this->AddPentagramJewelInfo(aIndex, 0, iJewelIndex, iItemType, iItemIndex, iMainAttribute,
                                                    iJewelLevel,
                                                    iRank1OptionNum, iRank1Level, iRank2OptionNum, iRank2Level,
                                                    iRank3OptionNum, iRank3Level,
                                                    iRank4OptionNum, iRank4Level, iRank5OptionNum, iRank5Level);
...
bool CPentagramSystem::AddPentagramJewelInfo(int aIndex, int iJewelPos, int iJewelIndex, int iItemType, int iItemIndex,
                                             int iMainAttribute, int iJewelLevel, BYTE btRank1OptionNum,
                                             BYTE btRank1Level, BYTE btRank2OptionNum, BYTE btRank2Level,
                                             BYTE btRank3OptionNum, BYTE btRank3Level, BYTE btRank4OptionNum,
                                             BYTE btRank4Level, BYTE btRank5OptionNum, BYTE btRank5Level) {
    LPOBJ lpObj = &gObj[aIndex];
    ...
    this->DBREQ_InsertPentagramJewel(aIndex, iJewelPos, iJewelIndex, iItemType, iItemIndex, iMainAttribute,
                                     ...
                                     btRank3OptionNum, btRank3Level, btRank4OptionNum, btRank4Level, btRank5OptionNum,
                                     btRank5Level);
...
void CPentagramSystem::DBANS_GetPentagramJewel(LPBYTE lpRecv) {
    ...
    if (lpMsg->iAnsType == 1) {
        for (int i = 0; i < lpMsg->btJewelCnt; i++) {
            PENTAGRAMJEWEL_INFO *lpPentagramInfo = (PENTAGRAMJEWEL_INFO *) (lpRecv + sizeof(PMSG_ANS_PENTAGRAMJEWEL) +
        ...
        if (lpObj->pInventory[236].IsItem() == TRUE) {
            ...
            GSProtocol.GCReFillSend(aIndex, lpObj->MaxLife + lpObj->AddLife, 0xFE, 0,
    ...
    if (iJewelPos == 1) {
        ...
        for (int i = 0; i < WAREHOUSE_SIZE; i++) {
            if (lpObj->pWarehouse[i].IsItem() == TRUE &&
                ...
                g_Log.Add(
                        "[PentagramItemWithJewelAllInfo_Warehouse](%s)(%s) WarehouseNo:[%d] Item:[%s,%d,%d,%d,%d]serial:[%I64d] Dur:[%d] Ex:[%d,%d,%d,%d,%d,%d,%d] Set:[%d] 380:[%d] HO:[%d,%d] Socket[%d,%d,%d,%d,%d], MainAttribute[%d]",
                        ...
                        g_kJewelOfHarmonySystem.GetItemStrengthenOption(&lpObj->pWarehouse[i]),
                        g_kJewelOfHarmonySystem.GetItemOptionLevel(&lpObj->pWarehouse[i]),
                ...
                for (int j = 0; j < 5; j++) {
                    if (lpObj->pWarehouse[i].m_SocketOption[j] < 0xFE) {
                        for (int k = 0; k < 250; k++) {
                            if (lpObj->m_PlayerData->m_PentagramJewelInfo_Warehouse[k].btJewelIndex ==
                                lpObj->pWarehouse[i].m_SocketOption[j]) {
                                g_Log.Add(
                                        "[PentagramJewelInfo_Warehouse][%s][%s] WarehouseNo = [%d] DBIndex = %d, ItemType = %d, ItemIndex = %d, MainAttribute = %d, CurRank = %d, 1RankN/L = %d/%d, 2RankN/L = %d/%d, 3RankN/L = %d/%d, 4RankN/L = %d/%d, 5RankN/L = %d/%d ",
                                        ...
                                        (lpObj->m_PlayerData->m_PentagramJewelInfo_Warehouse[k].btMainAttribute & 0xF0)
                                                >> 4,
        ...
        for (int i = 0; i < INVENTORY_SIZE; i++) {
            if (lpObj->pInventory[i].IsItem() == TRUE &&
                ...
                g_Log.Add(
                        "[PentagramItemWithJewelAllInfo_Inven](%s)(%s) InvenNo:[%d] Item:[%s,%d,%d,%d,%d]serial:[%I64d] Dur:[%d] Ex:[%d,%d,%d,%d,%d,%d,%d] Set:[%d] 380:[%d] HO:[%d,%d] Socket[%d,%d,%d,%d,%d], MainAttribute[%d]",
                        ...
                        g_kJewelOfHarmonySystem.GetItemStrengthenOption(&lpObj->pInventory[i]),
                        g_kJewelOfHarmonySystem.GetItemOptionLevel(&lpObj->pInventory[i]),
                ...
                for (int j = 0; j < 5; j++) {
                    if (lpObj->pInventory[i].m_SocketOption[j] < 0xFE) {
                        for (int k = 0; k < 250; k++) {
                            if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[k].btJewelIndex ==
                                lpObj->pInventory[i].m_SocketOption[j]) {
                                g_Log.Add(
                                        "[PentagramJewelInfo_Inven][%s][%s] InvenNo = [%d] DBIndex = %d, ItemType = %d, ItemIndex = %d, MainAttribute = %d, CurRank = %d, 1RankN/L = %d/%d, 2RankN/L = %d/%d, 3RankN/L = %d/%d, 4RankN/L = %d/%d, 5RankN/L = %d/%d ",
                                        lpObj->AccountID, lpObj->Name, i,
                                        ...
                                        (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[k].btMainAttribute & 0xF0)
                                                >> 4,
...
void
CPentagramSystem::DBREQ_InsertPentagramJewel(int aIndex, int iJewelPos, int iJewelIndex, int iItemType, int iItemIndex,
                                             int iMainAttribute, int iJewelLevel, BYTE btRank1, BYTE btRank1Level,
                                             BYTE btRank2, BYTE btRank2Level, BYTE btRank3, BYTE btRank3Level,
                                             BYTE btRank4, BYTE btRank4Level, BYTE btRank5, BYTE btRank5Level) {
...
BOOL CPentagramSystem::PentagramJewel_IN(int aIndex, int iPentagramItemPos, int iJewelItemPos) {
    ...
    for (int index = 0; index < 250; index++) {
        ...
        for (int i = 0; i < 250; i++) {
            if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btJewelIndex != 0xFF &&
                lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btJewelIndex == index) {
                bIndexExist = true;
            }
        }
    ...
    this->DBREQ_InsertPentagramJewel(aIndex, btJewelPos, btJewelIndex, btItemType, wItemIndex, btMainAttribute,
                                     btJewelLevel,
                                     btRank1OptionNum, btRank1Level, btRank2OptionNum, btRank2Level, btRank3OptionNum,
                                     btRank3Level, btRank4OptionNum, btRank4Level, btRank5OptionNum, btRank5Level);

    gObjInventoryDeleteItem(aIndex, iJewelItemPos);
    GSProtocol.GCInventoryItemDeleteSend(aIndex, iJewelItemPos, 0);
    GSProtocol.GCAnsInJewelPentagramItem(aIndex, 1, btJewelPos, btJewelIndex, btItemType, wItemIndex, btMainAttribute,
                                         btJewelLevel, btRank1OptionNum, btRank1Level, btRank2OptionNum, btRank2Level,
                                         btRank3OptionNum, btRank3Level, btRank4OptionNum, btRank4Level,
                                         btRank5OptionNum, btRank5Level);
    ...
    g_Log.Add(
            "[PentagramJewel_IN] User:%s(%s) Item:[%s,%d,%d,%d,%d]serial:[%I64d] Dur:[%d] Ex:[%d,%d,%d,%d,%d,%d,%d] Set:[%d] 380:[%d] HO:[%d,%d] Socket[%d,%d,%d,%d,%d], \t\t\t BonusOption[%d] JewelType:%d, JewelIndex:%d, DBIndex:%d, MainAttribute:%d, CurRank:%d, 1RankN/L:%d, 2RankN/L:%d, 3RankN/L:%d, 4RankN/L:%d, 5RankN/L:%d",
            ...
            g_kJewelOfHarmonySystem.GetItemStrengthenOption(&lpObj->pInventory[iPentagramItemPos]),
            g_kJewelOfHarmonySystem.GetItemOptionLevel(&lpObj->pInventory[iPentagramItemPos]),
            lpObj->pInventory[iPentagramItemPos].m_SocketOption[0],
            lpObj->pInventory[iPentagramItemPos].m_SocketOption[1],
            lpObj->pInventory[iPentagramItemPos].m_SocketOption[2],
            lpObj->pInventory[iPentagramItemPos].m_SocketOption[3],
            lpObj->pInventory[iPentagramItemPos].m_SocketOption[4],
            lpObj->pInventory[iPentagramItemPos].m_BonusSocketOption,
...
BOOL CPentagramSystem::PentagramJewel_OUT(int aIndex, int iPentagramItemPos, BYTE btSocketIndex, BYTE *btJewelPos,
                                          BYTE *btJewelDBIndex) {
    if (!gObjIsConnected(aIndex)) {
        return FALSE;
    }
    ...
    for (int i = 0; i < 250; i++) {
        if (lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btJewelIndex == iJewelDBIndex) {
            ...
            if ((rand() % 10000) >= iOutRate) {
                g_Log.Add(
                        "[PentagramJewel_OUT][%s][%s] PentagramJewel Out Fail - JewelDBIndex = %d, ItemType = %d, ItemIndex = %d",
                        lpObj->AccountID, lpObj->Name, btJewelDBIndex, iItemType, iItemIndex);

                iReturnValue = 2;
            } else {
                int iResultItemCode = ITEMGET(lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btItemType,
                                              lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].wItemIndex);
                int iItemDurability = ItemGetDurability(iResultItemCode, iJewelLevel, 0, 0);
                if (!CheckInventoryEmptySpace(lpObj, ItemAttribute[iResultItemCode].Height,
                                              ItemAttribute[iResultItemCode].Width))
                    return 0x64;

                BYTE btSocketOption[5];
                btSocketOption[0] = lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank1OptionNum |
                                    0x10 * lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank1Level;
                btSocketOption[1] = lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank2OptionNum |
                                    0x10 * lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank2Level;
                btSocketOption[2] = lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank3OptionNum |
                                    0x10 * lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank3Level;
                btSocketOption[3] = lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank4OptionNum |
                                    0x10 * lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank4Level;
                btSocketOption[4] = lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank5OptionNum |
                                    0x10 * lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btRank5Level;

                ItemSerialCreateSend(aIndex, 231, 0, 0, iResultItemCode, iJewelLevel, iItemDurability, 0, 0, 0, 0, 0, 0,
                                     0, btSocketOption,
                                     lpObj->m_PlayerData->m_PentagramJewelInfo_Inven[i].btMainAttribute);
                g_Log.Add(
                        "[PentagramJewel_OUT][%s][%s] PentagramJewel Out Success - JewelDBIndex = %d, ItemType = %d, ItemIndex = %d",
...
BOOL CPentagramSystem::AddTradeCount(OBJECTSTRUCT *lpObj, int source, int target) {
    ...
    g_Log.Add("[%s][%s] After using Add Trade Count Stamp(%I64d) : (%s) serial:(%I64d) TradeCount:%d-->%d",
              lpObj->AccountID, lpObj->Name, lpObj->pInventory[source].m_Number, lpObj->pInventory[target].GetName(),

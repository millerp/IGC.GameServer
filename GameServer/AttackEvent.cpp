...
void CAttackEvent::ClearMonster() {
    ...
    for (std::map<int, ATTACKEVENT_MONSTER_INFO>::iterator It = this->m_mapMonsterInfo.begin();
         It != this->m_mapMonsterInfo.end(); It++) {
...
void CAttackEvent::Active() {
    ...
    for (int i = 0; i < It->second.m_Count; i++) {
        ...
        while (this->GetBoxPosition(MapNumber, It->second.m_X, It->second.m_Y, It->second.m_W, It->second.m_H,
                                    gObj[result].X, gObj[result].Y) == 0) {
        ...
        g_Log.Add("[AttackEvent] Create Boss %d: %d %d %d create ", It->second.m_Type, this->m_BossMap53,
                  this->m_BossMapX53, this->m_BossMapY53);
    }
    ...
    for (int i = 0; i < It->second.m_Count; i++) {
        ...
        this->GetBoxPosition(MapNumber, this->m_BossMapX53 - 4, this->m_BossMapY53 - 4, this->m_BossMapX53 + 4,
                             this->m_BossMapY53 + 4, gObj[result].X, gObj[result].Y);
    ...
    for (int i = 0; i < It->second.m_Count; i++) {
        ...
        g_Log.Add("[AttackEvent] Create Boss %d: %d %d %d create ", It->second.m_Type, this->m_BossMap55,
                  this->m_BossMapX55, this->m_BossMapY55);
    }
    ...
    for (int i = 0; i < It->second.m_Count; i++) {
        ...
        this->GetBoxPosition(MapNumber, this->m_BossMapX55 - 4, this->m_BossMapY55 - 4, this->m_BossMapX55 + 4,
                             this->m_BossMapY55 + 4, gObj[result].X, gObj[result].Y);

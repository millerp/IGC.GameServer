        ...
        for (int i = 0; i < count; i++) {
            if (m_Queue.size()) {
                ...
                if (pAtt) {
                    ...
                    pAtt->Process();
                    delete pAtt; // nie wiem juz co robic ^. Kurde to jest przypadek tak specyficzny. Przecie� pop() idzie niemal w tym samym monencie co front(). Musia�oby w tym samym momencie w obu w�tkach wywo�a� front().... Sytuacja 1 na milion, nie wiem czemu tak sie dzieje...
                } else {

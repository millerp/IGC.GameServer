...
void CObjCalCharacter::CalcCharacter(int aIndex) {
    ...
    switch (lpObj->Class) {
        ...
        case CLASS_SUMMONER:
            this->m_Lua.Generic_Call("SummonerMagicDamageCalc", "i>iiii", Energy,
                                     &lpObj->m_MagicDamageMin, &lpObj->m_MagicDamageMax, &lpObj->m_CurseDamageMin,
    ...
    if (Right->m_Type != ITEMGET(4, 7) && Right->m_Type != ITEMGET(4, 15) && Right->m_Type >= ITEMGET(0, 0) &&
        Right->m_Type < ITEMGET(6, 0)) {
        if (Right->m_IsValidItem != false) {
            bRight = true;
        }
    }

    if (Left->m_Type != ITEMGET(4, 7) && Left->m_Type != ITEMGET(4, 15) && Left->m_Type >= ITEMGET(0, 0) &&
        Left->m_Type < ITEMGET(6, 0)) {
        if (Left->m_IsValidItem != false) {
            bLeft = true;
        }
    }
    ...
    if (Wing->IsItem() == TRUE && Wing->m_IsValidItem == true &&
        Wing->m_Type == ITEMGET(12, 268)) // additional bonus of s9 wings
    {
    ...
    // Wizard Ring effect
    if ((lpObj->pInventory[10].IsItem() == TRUE && lpObj->pInventory[10].m_Type == ITEMGET(13, 20) &&
         lpObj->pInventory[10].m_Level == 0 && lpObj->pInventory[10].m_Durability > 0.0f) ||
        (lpObj->pInventory[11].IsItem() == TRUE && lpObj->pInventory[11].m_Type == ITEMGET(13, 20) &&
         lpObj->pInventory[11].m_Level == 0 && lpObj->pInventory[11].m_Durability > 0.0f)) {
    ...
    if ((lpObj->pInventory[10].IsItem() == TRUE && lpObj->pInventory[10].m_Type == ITEMGET(13, 107) &&
         lpObj->pInventory[10].m_Level == 0 && lpObj->pInventory[10].m_Durability > 0.0f) ||
        (lpObj->pInventory[11].IsItem() == TRUE && lpObj->pInventory[11].m_Type == ITEMGET(13, 107) &&
         lpObj->pInventory[11].m_Level == 0 && lpObj->pInventory[11].m_Durability > 0.0f)) {
    ...
    if (Helper->m_Type == ITEMGET(13, 123) && Helper->IsPeriodItemExpire() == FALSE) {
        lpObj->m_AttackDamageMinRight +=
                lpObj->m_AttackDamageMinRight * g_ConfigRead.pet.EliteSkeletonPetAddDamage / 100;
        lpObj->m_AttackDamageMaxRight +=
                lpObj->m_AttackDamageMaxRight * g_ConfigRead.pet.EliteSkeletonPetAddDamage / 100;
    ...
    this->m_Lua.Generic_Call("CalcAttackSuccessRate_PvM", "iiiii>i", lpObj->Class, Strength, Dexterity,
                             Leadership, (lpObj->Level + lpObj->m_PlayerData->MasterLevel),
    ...
    this->m_Lua.Generic_Call("CalcAttackSuccessRate_PvP", "iii>d", lpObj->Class,
                             (lpObj->m_PlayerData->Dexterity + lpObj->AddDexterity),
                             lpObj->Level + lpObj->m_PlayerData->MasterLevel, &lpObj->m_PlayerData->m_AttackRatePvP);
    this->m_Lua.Generic_Call("CalcDefenseSuccessRate_PvP", "iii>d", lpObj->Class,
                             (lpObj->m_PlayerData->Dexterity + lpObj->AddDexterity),
                             lpObj->Level + lpObj->m_PlayerData->MasterLevel, &lpObj->m_PlayerData->m_DefenseRatePvP);
    ...
    if (lpObj->m_btInvenPetPos != FALSE && lpObj->pInventory[lpObj->m_btInvenPetPos].m_JewelOfHarmonyOption == TRUE) {
        if (lpObj->pInventory[lpObj->m_btInvenPetPos].m_Type == ITEMGET(13, 4) &&
            lpObj->pInventory[lpObj->m_btInvenPetPos].m_Durability > 0.0f)    // Dark Horse
        {
            int addDefense = 0;
            this->m_Lua.Generic_Call("CalcDarkHorseDefenseBonus", "ii>i", Dexterity,
                                     lpObj->pInventory[lpObj->m_btInvenPetPos].m_PetItem_Level, &addDefense);
    ...
    if ((Level15Count + Level14Count + Level13Count + Level12Count + Level11Count + Level10Count) >= 5) {
        if (Success != false) {
            ...
            } else if (Level11Count == 5 ||
                       (Level11Count + Level12Count + Level13Count + Level14Count + Level15Count) == 5) {
                lpObj->m_Defense += lpObj->m_Defense * 10 / 100;
            } else if (Level10Count == 5 ||
                       (Level10Count + Level11Count + Level12Count + Level13Count + Level14Count + Level15Count) == 5) {
    ...
    if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 10) && LeftRing->m_Level == 5) ||
        (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 10) && RightRing->m_Level == 5)) {
        lpObj->AddLife = ((int) (lpObj->MaxLife * 20.0f)) / 100;
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 39)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 39))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 41)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 41))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 42)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 42))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 76)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 76))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 77)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 77))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 78)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 78))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 122)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 122))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 163)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 163))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 164)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 164))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 165)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 165))) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 169) && LeftRing->m_Durability > 0.0) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 169) &&
                RightRing->m_Durability > 0.0)) {
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 170) && LeftRing->m_Durability > 0.0) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 170) &&
                RightRing->m_Durability > 0.0)) {
        lpObj->m_AttackDamageMinRight +=
                lpObj->m_AttackDamageMinRight * g_ConfigRead.pet.BlessedDecorationRingAddDamage / 100;
        lpObj->m_AttackDamageMaxRight +=
                lpObj->m_AttackDamageMaxRight * g_ConfigRead.pet.BlessedDecorationRingAddDamage / 100;
        lpObj->m_AttackDamageMinLeft +=
                lpObj->m_AttackDamageMinLeft * g_ConfigRead.pet.BlessedDecorationRingAddDamage / 100;
        lpObj->m_AttackDamageMaxLeft +=
                lpObj->m_AttackDamageMaxLeft * g_ConfigRead.pet.BlessedDecorationRingAddDamage / 100;
    ...
    } else if ((LeftRing->IsItem() == TRUE && LeftRing->m_Type == ITEMGET(13, 268)) ||
               (RightRing->IsItem() == TRUE && RightRing->m_Type == ITEMGET(13, 268))) {
    ...
    if (lpObj->pInventory[lpObj->m_btInvenPetPos].m_Type == ITEMGET(13, 37) &&
        ...
        lpObj->pInventory[lpObj->m_btInvenPetPos].m_JewelOfHarmonyOption == TRUE) //Golden Fenrir Attribute
    {
    ...
    if (lpObj->Type == OBJ_USER && lpObj->m_PlayerData->ISBOT == false) {
        gDarkSpirit[lpObj->m_Index - g_ConfigRead.server.GetObjectStartUserIndex()].Set(lpObj->m_Index,
                                                                                        &lpObj->pInventory[1]);
    }
...
#define GET_MAX_RESISTANCE(x, y, z) ( ( ( ( (x) > (y) ) ? (x) : (y) ) > (z) ) ? ( ( (x) > (y) ) ? (x) : (y) ) : (z) )
    ...
    lpObj->m_Resistance[1] = GET_MAX_RESISTANCE(rItem[0]->m_Resistance[1], rItem[1]->m_Resistance[1],
                                                rItem[2]->m_Resistance[1]);
    lpObj->m_Resistance[0] = GET_MAX_RESISTANCE(rItem[0]->m_Resistance[0], rItem[1]->m_Resistance[0],
                                                rItem[2]->m_Resistance[0]);
    lpObj->m_Resistance[2] = GET_MAX_RESISTANCE(rItem[0]->m_Resistance[2], rItem[1]->m_Resistance[2],
                                                rItem[2]->m_Resistance[2]);
    lpObj->m_Resistance[3] = GET_MAX_RESISTANCE(rItem[0]->m_Resistance[3], rItem[1]->m_Resistance[3],
                                                rItem[2]->m_Resistance[3]);
    lpObj->m_Resistance[4] = GET_MAX_RESISTANCE(rItem[0]->m_Resistance[4], rItem[1]->m_Resistance[4],
                                                rItem[2]->m_Resistance[4]);
    lpObj->m_Resistance[5] = GET_MAX_RESISTANCE(rItem[0]->m_Resistance[5], rItem[1]->m_Resistance[5],
                                                rItem[2]->m_Resistance[5]);
    lpObj->m_Resistance[6] = GET_MAX_RESISTANCE(rItem[0]->m_Resistance[6], rItem[1]->m_Resistance[6],
                                                rItem[2]->m_Resistance[6]);
    ...
    for (int i = 0; i < 3; i++) {
        switch (rItem[i]->m_Type) {
            case ITEMGET(13, 171):
                for (int j = 0; j < 6; j++) {
                    if (rItem[i]->m_Type == ITEMGET(g_ItemOptionTypeMng.m_AccessoryItemOptionValue[j].ItemType,
                                                    g_ItemOptionTypeMng.m_AccessoryItemOptionValue[j].ItemIndex)) {
    ...
    if (lpObj->Class == CLASS_KNIGHT || lpObj->Class == CLASS_MAGUMSA || lpObj->Class == CLASS_DARKLORD) {
        if (Right->m_Type != -1 && Left->m_Type != -1) {
            if (Right->m_Type >= ITEMGET(0, 0) && Right->m_Type < ITEMGET(4, 0) && Left->m_Type >= ITEMGET(0, 0) &&
                Left->m_Type < ITEMGET(4, 0)) {
                if (Right->m_Type == Left->m_Type && (lpObj->Class == CLASS_KNIGHT || lpObj->Class == CLASS_MAGUMSA)) {
                    this->m_Lua.Generic_Call("CalcTwoSameWeaponBonus", "iiii>iiii", lpObj->m_AttackDamageMinLeft,
                                             lpObj->m_AttackDamageMaxLeft,
                                             lpObj->m_AttackDamageMinRight, lpObj->m_AttackDamageMaxRight,
                                             &lpObj->m_AttackDamageMinLeft, &lpObj->m_AttackDamageMinRight,
                                             &lpObj->m_AttackDamageMaxLeft, &lpObj->m_AttackDamageMaxRight);
                } else {
                    this->m_Lua.Generic_Call("CalcTwoDifferentWeaponBonus", "iiii>iiii", lpObj->m_AttackDamageMinLeft,
                                             lpObj->m_AttackDamageMaxLeft,
                                             lpObj->m_AttackDamageMinRight, lpObj->m_AttackDamageMaxRight,
                                             &lpObj->m_AttackDamageMinLeft, &lpObj->m_AttackDamageMinRight,
                                             &lpObj->m_AttackDamageMaxLeft, &lpObj->m_AttackDamageMaxRight);
    ...
    if (lpObj->Class == CLASS_RAGEFIGHTER) {
        if (Right->m_Type != -1 && Left->m_Type != -1) {
            if (Right->m_Type >= ITEMGET(0, 0) && Right->m_Type < ITEMGET(4, 0) && Left->m_Type >= ITEMGET(0, 0) &&
                Left->m_Type < ITEMGET(4, 0)) {
                this->m_Lua.Generic_Call("CalcRageFighterTwoWeaponBonus", "iiii>iiii", lpObj->m_AttackDamageMinLeft,
                                         lpObj->m_AttackDamageMaxLeft,
                                         lpObj->m_AttackDamageMinRight, lpObj->m_AttackDamageMaxRight,
                                         &lpObj->m_AttackDamageMinLeft, &lpObj->m_AttackDamageMinRight,
                                         &lpObj->m_AttackDamageMaxLeft, &lpObj->m_AttackDamageMaxRight);
...
void CObjCalCharacter::GetSetItemOption(LPOBJ lpObj, LPBYTE pSetOptionTable, LPBYTE pSetOptionCountTable,
                                        int *pSetOptionCount) {
    *pSetOptionCount = 0;
                ...
                if (iSetItemOption != -1) {
                    if (i == 0) {
                        ...
                        if (RightSetOptionIndex == iSetItemOption) {
                            if (lpObj->pInventory[0].GetWeaponType() == lpObj->pInventory[1].GetWeaponType() &&
                                lpObj->pInventory[0].IsSetItem()) {
                                continue;
                            }
                        }
                    }
                    ...
                    if (i == 10) {
                        ...
                        if (lpObj->pInventory[10].m_Type == lpObj->pInventory[11].m_Type &&
                            lpObj->pInventory[10].IsSetItem()) {
                            continue;
                        }
                    }
        ...
        if (OptionTableCount >= 2) {
            ...
            for (int tablecnt = 0; tablecnt < (OptionTableCount - 1); tablecnt++) {
                if (gSetItemOption.GetSetOption(OptionTableIndex, tablecnt,
                                                op1, op2, opvalue1, opvalue2, lpObj->Class,
...
void CObjCalCharacter::SetItemPlusSpecial(LPOBJ lpObj, int option, int ivalue) {
    ...
    switch (option) {
        ...
        case AT_SET_OPTION_IMPROVE_ATTACKDAMAGE_WITH_DEX:
            lpObj->m_PlayerData->SetOpAddAttackDamage +=
                    (lpObj->m_PlayerData->Dexterity + lpObj->AddDexterity) / ivalue;
            break;
...
void CObjCalCharacter::CalcMLSkillItemOption(LPOBJ lpObj) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsTwoHandSwordAddDamage > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() != ITEM_TWOHAND_SWORD &&
            lpObj->pInventory[1].GetDetailItemType() != ITEM_TWOHAND_SWORD) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsTwoHandsMagicPower > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() == ITEM_TWOHAND_STAFF ||
            lpObj->pInventory[1].GetDetailItemType() == ITEM_TWOHAND_STAFF) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsStaffMagicPower > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() == ITEM_ONEHAND_STAFF ||
            lpObj->pInventory[1].GetDetailItemType() == ITEM_ONEHAND_STAFF) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsAddMagicPowerStick > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() == ITEM_SUMMONER_STAFF ||
            lpObj->pInventory[1].GetDetailItemType() == ITEM_SUMMONER_STAFF) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsIncShield > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() == ITEM_SHIELD ||
            lpObj->pInventory[1].GetDetailItemType() == ITEM_SHIELD) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsAddAttackSpeedMagicBook > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() == ITEM_SUMMONER_BOOK ||
            lpObj->pInventory[1].GetDetailItemType() == ITEM_SUMMONER_BOOK) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsTwoHandsBowManAttack > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() != ITEM_CROSSBOW &&
            lpObj->pInventory[1].GetDetailItemType() != ITEM_CROSSBOW) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsSwordAddDamage > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() != ITEM_ONEHAND_SWORD &&
            lpObj->pInventory[1].GetDetailItemType() != ITEM_ONEHAND_SWORD) {
            lpObj->m_PlayerData->m_MPSkillOpt.iMpsSwordAddDamage = 0.0;
        }
    }

    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsScultAddDamage > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() != ITEM_MACE &&
            lpObj->pInventory[1].GetDetailItemType() != ITEM_MACE) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsSpearAddDamage > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() != ITEM_SPEAR &&
            lpObj->pInventory[1].GetDetailItemType() != ITEM_SPEAR) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsBowAddDamage > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() != ITEM_BOW &&
            lpObj->pInventory[1].GetDetailItemType() != ITEM_BOW) {
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsIncDarkHorseDefense > 0.0 &&
    ...
    if (lpObj->m_PlayerData->m_MPSkillOpt.iMpsMonkWeaponDamage > 0.0) {
        if (lpObj->pInventory[0].GetDetailItemType() != ITEM_RAGEFIGHTER_WEAPON &&
            lpObj->pInventory[1].GetDetailItemType() != ITEM_RAGEFIGHTER_WEAPON) {
...
BOOL CObjCalCharacter::ValidItem(LPOBJ lpObj, CItem *lpItem, int pos) {
    ...
    if (p->RequireStrength != 0) {
        if ((lpObj->m_PlayerData->Strength + lpObj->AddStrength) <
            (lpItem->m_RequireStrength - lpItem->m_HJOpStrength)) {
            return FALSE;
        }
    }

    if (p->RequireDexterity != 0) {
        if ((lpObj->m_PlayerData->Dexterity + lpObj->AddDexterity) <
            (lpItem->m_RequireDexterity - lpItem->m_HJOpDexterity)) {
            return FALSE;
        }
    }
...
void CObjCalCharacter::CalcShieldPoint(LPOBJ lpObj) {
    ...
    int iExpressionA = (lpObj->m_PlayerData->Strength + lpObj->AddStrength) +
                       (lpObj->m_PlayerData->Dexterity + lpObj->AddDexterity) +

...
public:
    ...
    void SetitemDropRate(int iCategory, int iDropRate, int iSkillOptionRate, int iLuckOptionRate, int iAddOptionRate,
                         int iExOptionRate);

    BOOL
    InsertItem(int iItemCategory, int iItemType, int iItemIndex, int iItemLevelMin, int iItemLevelMax, int iSkillOption,
               int iLuckOption, int iAddOption, int iExOption);
...
extern CCashLotterySystem g_ChaosCard;
extern CCashLotterySystem g_ChaosCardMini;
extern CCashLotterySystem g_ChaosCardGold;
extern CCashLotterySystem g_ChaosCardRare;

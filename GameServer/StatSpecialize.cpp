...
void CStatSpecialize::CalcStatOption(LPOBJ lpObj, int StatOptionID) {
    ...
    this->m_Lua.Generic_Call("StatSpec_GetPercent", "iiiiiii>d",
                             (int) lpObj->Class, StatOptionID, (int) lpObj->m_PlayerData->Strength,
                             (int) lpObj->m_PlayerData->Dexterity,
                             (int) lpObj->m_PlayerData->Vitality, (int) lpObj->m_PlayerData->Energy,
                             (int) lpObj->Leadership, &Percent);

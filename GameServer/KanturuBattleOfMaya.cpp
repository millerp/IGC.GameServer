    ...
    try {
        ...
        for (pugi::xml_attribute ai_state = ai_settings.first_attribute(); ai_state; ai_state = ai_state.next_attribute()) {
            ...
            if (this->m_iMayaHAndGroupNumberCount < 0 ||
                ...
                g_Log.MsgBox("[Kanturu][Battle of Maya] - Maya Hand AI Group Read Error(%d)",
        ...
        for (pugi::xml_node ai = ai_settings.child("AI"); ai; ai = ai.next_sibling()) {
            ...
            if (this->m_iMayaHandAIChangeTimeCount < 0 ||
                ...
                g_Log.MsgBox("[Kanturu][Battle of Maya] - Exceed Maya Hand AI Change Time(%d)",
        ...
        g_Log.AddC(TColor::Red, "[Kanturu][Battle of Maya] %s file is Loaded", lpszFileName);
...
void CKanturuBattleOfMaya::SetState_NONE() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> NONE",
...
void CKanturuBattleOfMaya::SetState_STANBY1() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> STANBY1",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_NOTIFY1() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> NOTIFY1",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_START1() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> START1",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_MAYA1() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> MAYA1",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_END_MAYA1() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> END_MAYA1",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_ENDCYCLE_MAYA1() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> ENDCYCLE_MAYA1",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_STANBY2() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> STANBY2",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_START2() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> START2",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_MAYA2() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> MAYA2",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_END_MAYA2() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> END_MAYA2",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_ENDCYCLE_MAYA2() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> ENDCYCLE_MAYA2",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_STANBY3() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> STANBY3",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_START3() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> START3",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_MAYA3() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> MAYA3",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_END_MAYA3() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> END_MAYA3",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_ENDCYCLE_MAYA3() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> ENDCYCLE_MAYA3",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::SetState_END() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> END",
               this->m_iBattleOfMayaState);
    ...
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] Success Value[%d]",
               this->GetSuccessValue());
}


void CKanturuBattleOfMaya::SetState_ENDCYCLE() {
    g_Log.AddC(TColor::Brown, "[Kanturu][Battle of Maya] State(%d) -> ENDCYCLE",
               this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::ProcState_START1() {
    if (g_KanturuMonsterMng.IsExistAliveMonster() == FALSE) {
        ...
        g_Log.Add("[Kanturu][Battle of Maya] Success!! - DetailState:%d",
                  this->m_iBattleOfMayaState);
    ...
    if (this->GetBattleSceneState() != -1) {
        ...
        if (this->m_BattleTimeInfo[this->m_iSceneState].IsTimeOut() == TRUE) {
            if (this->GetBattleOfMayaState() != KANTURU_MAYA_END) {
                ...
                g_Log.Add("[Kanturu][Battle of Maya] Fail!! TimeOut - DetailState:%d",
                          this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::CheckMayaBattleUser() {
    if (this->GetBattleOfMayaState() == KANTURU_MAYA_NOTIFY1 ||
        ...
        if (g_KanturuBattleUserMng.IsEmpty() == TRUE) {
            ...
            g_Log.Add("[Kanturu][Battle of Maya] Fail!! All Battle User Die - DetailState:%d",
                      this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::ChangeAI(int iGroupNumber) {
    if ((GetTickCount() - this->m_iMayaHandAIAppliedTime) >=
        this->m_iMayaHandAIChangeTime[this->m_iMayaHandCurrentAI]) {
        this->m_iMayaHandAIAppliedTime = GetTickCount();

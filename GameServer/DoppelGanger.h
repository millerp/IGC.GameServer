...
public:
    ...
    int AddMonsterEX(int iMonsterType, int bAttackFirst, int nMonsterLevel, int nMonsterHp, int nMonsterAttMin,
                     int nMonsterAttMax, int nMonsterDef);
...
public:
    ...
    int AddMonsterLarva(int nMapNumber, BYTE btX, BYTE btY, int nMonsterLevel, int nMonsterHp, int nMonsterAttMin,
                        int nMonsterAttMax, int nMonsterDef);

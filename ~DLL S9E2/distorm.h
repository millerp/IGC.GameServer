...
typedef enum {
    DECRES_NONE, DECRES_SUCCESS, DECRES_MEMORYERR, DECRES_INPUTERR
} _DecodeResult;
...
_DecodeResult
distorm_decode64(_OffsetType codeOffset, const unsigned char *code, int codeLen, _DecodeType dt, _DecodedInst result[],

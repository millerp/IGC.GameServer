...
void CameraV2::Load() {
    SetOp((LPVOID) 0x004DF15A, (LPVOID)
    this->GetZoom, CALL);
}
// ----------------------------------------------------------------------------------------------
...
void CameraV2::Run(MOUSEHOOKSTRUCTEX *Mouse, WPARAM wParam) {
...
float CameraV2::GetZoom(LPVOID This, LPVOID EDX) {
    if (pPlayerState != GameProcess) {

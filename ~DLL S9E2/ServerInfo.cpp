...
void CServerInfo::Load(std::string file)
{
	...
	decFile << buf;
	decFile.close();
	GetPrivateProfileStringA("Connection", "IP", 0, szTemp, 250, filedec);
	...
	GetPrivateProfileStringA("Main", "Version", "1.05.13", szTemp, 8, filedec);
	...
	GetPrivateProfileStringA("Main", "Serial", "PowerIGCNetwork1", szTemp, 17, filedec);
	...
	m_Charset = GetPrivateProfileIntA("Gameplay", "CodePage", 0x4E4, filedec);

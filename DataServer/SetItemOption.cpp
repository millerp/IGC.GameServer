...
BOOL CSetItemOption::LoadOptionInfo(LPSTR
filename)
{
int i;
int Token;
...
Token = GetToken();
strcpy(&p
->Name[0], &TokenString[0]);

for (
i = 0;
i<OPTION_TABLE_SIZE;i++)
{
Token = GetToken();
p->SetOptionTable[i][0] =
TokenNumber;
Token = GetToken();
p->SetOptionTableValue[i][0] =
TokenNumber;

Token = GetToken();
p->SetOptionTable[i][1] =
TokenNumber;
Token = GetToken();
p->SetOptionTableValue[i][1] =
TokenNumber;
...
Token = GetToken();
p->SetExPOptionTable[0]  =
TokenNumber;
Token = GetToken();
p->SetExPOptionTableValue[0] =
TokenNumber;
...
Token = GetToken();
p->SetExPOptionTable[1]  =
TokenNumber;
Token = GetToken();
p->SetExPOptionTableValue[1] =
TokenNumber;
...
// Full Type Set Item
Token = GetToken();
p->SetFullOtionTable[0]=
TokenNumber;
Token = GetToken();
p->SetFullOtionTableValue[0]=
TokenNumber;

Token = GetToken();
p->SetFullOtionTable[1]=
TokenNumber;
Token = GetToken();
p->SetFullOtionTableValue[1]=
TokenNumber;

Token = GetToken();
p->SetFullOtionTable[2]=
TokenNumber;
Token = GetToken();
p->SetFullOtionTableValue[2]=
TokenNumber;

Token = GetToken();
p->SetFullOtionTable[3]=
TokenNumber;
Token = GetToken();
p->SetFullOtionTableValue[3]=
TokenNumber;

Token = GetToken();
p->SetFullOtionTable[4]=
TokenNumber;
Token = GetToken();
p->SetFullOtionTableValue[4]=
TokenNumber;

// Save Character Class Disponibility
Token = GetToken();
p->RequireClass[CLASS_WIZARD]=
TokenNumber;

Token = GetToken();
p->RequireClass[CLASS_KNIGHT]=
TokenNumber;

Token = GetToken();
p->RequireClass[CLASS_ELF]=
TokenNumber;

Token = GetToken();
p->RequireClass[CLASS_MAGUMSA]=
TokenNumber;

Token = GetToken();
p->RequireClass[CLASS_DARKLORD]=
TokenNumber;
...
if (Token==0 && strcmp("end", WzMemScript.
...
{
Token = WzMemScript.GetToken();
p->SetOptionTable[i][0] = WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetOptionTableValue[i][0] =WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetOptionTable[i][1] = WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetOptionTableValue[i][1] =WzMemScript.
...
// Special Set Item Options
Token = WzMemScript.GetToken();
p->SetExPOptionTable[0]  = WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetExPOptionTableValue[0] = WzMemScript.
...
Token = WzMemScript.GetToken();
p->SetExPOptionTable[1]  = WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetExPOptionTableValue[1] = WzMemScript.
...
// Full Type Set Item
Token = WzMemScript.GetToken();
p->SetFullOtionTable[0]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTableValue[0]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTable[1]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTableValue[1]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTable[2]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTableValue[2]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTable[3]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTableValue[3]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTable[4]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->SetFullOtionTableValue[4]=WzMemScript.

GetNumber();

// Save Character Class Disponibility
Token = WzMemScript.GetToken();
p->RequireClass[CLASS_WIZARD]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->RequireClass[CLASS_KNIGHT]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->RequireClass[CLASS_ELF]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->RequireClass[CLASS_MAGUMSA]=WzMemScript.

GetNumber();

Token = WzMemScript.GetToken();
p->RequireClass[CLASS_DARKLORD]=WzMemScript.
...
int CSetItemOption::GetSetOption(int optionindex, int optablenum, int &op1, int &op2, int &opvalue1, int &opvalue2,
                                 int Class, int ChangeUp) {
    opvalue1 = 0;
    opvalue2 = 0;
...
int
CSetItemOption::GetGetFullSetOption(int optionindex, int &op1, int &op2, int &op3, int &op4, int &op5, int &opvalue1,
                                    int &opvalue2, int &opvalue3, int &opvalue4, int &opvalue5, int Class,
                                    int ChangeUp) {
    opvalue1 = 0;
    opvalue2 = 0;
    opvalue3 = 0;
...
int CSetItemOption::CheckMixContition(int itemnum, int mixitemlevel) {
    ...
    if (this->m_SetItemTypeInfo[itemnum].ChaosMixLevel[0] == mixitemlevel ||
        this->m_SetItemTypeInfo[itemnum].ChaosMixLevel[1] == mixitemlevel) {
        return 1;
    }
...
int CSetItemOption::GenRandomItemNum() {
    ...
    do {
        ...
        int maxindex = (g_MaxItemIndexOfEachItemType[type] <= 0) ? MAX_SUBTYPE_ITEMS
                                                                 : g_MaxItemIndexOfEachItemType[type];
